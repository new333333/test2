...
public interface IndexOptimization {
	
	public static final String OPTIMIZATION_GROUP="index-optimization";
	public static final String OPTIMIZATION_DESCRIPTION="Optimize Lucene index";
