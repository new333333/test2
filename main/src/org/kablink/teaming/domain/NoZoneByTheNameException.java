...
public class NoZoneByTheNameException extends NoObjectByTheNameException {
    ...
    public NoZoneByTheNameException(String zoneName) {
        super(NoZoneByTheNameException_ErrorCode, zoneName);
    }
    public NoZoneByTheNameException(String zoneName, String message) {
        super(NoZoneByTheNameException_ErrorCode, zoneName, message);
    }
    public NoZoneByTheNameException(String zoneName, String message, Throwable cause) {
        super(NoZoneByTheNameException_ErrorCode,zoneName, message, cause);
    }
