...
/**
 * This class handles the Email Report.
 * @author Peter Hurley
 *
 */
public class EmailReportController extends  AbstractReportController {
	/**
	 * 
	 */
	...
	protected String chooseView( Map formData ) {
		return WebKeys.VIEW_EMAIL_REPORT;
	}
}// end EmailReportController
