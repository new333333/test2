...
public abstract class NameMissingException extends UncheckedCodedException {
    ...
    public NameMissingException(String errorCode, Object[] errorArgs) {
        super(errorCode, errorArgs);
    }
    public NameMissingException(String errorCode, Object[] errorArgs, String message) {
        super(errorCode, errorArgs, message);
    }
    public NameMissingException(String errorCode, Object[] errorArgs, String message, Throwable cause) {
