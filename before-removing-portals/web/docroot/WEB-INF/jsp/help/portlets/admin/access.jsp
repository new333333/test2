...
<p><a href="javascript: ss_helpSystem.showHelpPanel('portlets/admin/access_users_groups', 'ss_moreinfo_panel', '', '');"><ssf:nlt tag="help.accessIntro.subTopic.usersGroups"/></a></p>
<p><a href="javascript: ss_helpSystem.showHelpPanel('portlets/admin/access_delegating', 'ss_moreinfo_panel', '', '');"><ssf:nlt tag="help.accessIntro.subTopic.delegating"/></a></p>
<p><a href="javascript: ss_helpSystem.showHelpPanel('portlets/admin/access_new_role', 'ss_moreinfo_panel', '', '');"><ssf:nlt tag="help.accessIntro.subTopic.defRoles"/></a></p>
</div>
...
<div class="not_last_link"><a href="javascript: ss_helpSystem.showMoreInfoPanel('portlets/admin/access_users_groups', 'ss_moreinfo_panel');">>></a><a id="skip_nav_panel_numbers" /><a id="skip_nav_all" /></div>
</div>
