...
<div id="ss_dashboard_content" class="ss_tricolumn">
  <div class="ss_colmid">
	...
	<ssf:canvas id="relevanceWhatsNew" type="inline" styleId="ss_trackedItems">
	<ssf:param name="title" useBody="true" >
		<div id="ss_title" class="ss_pt_title ss_green"> <ssf:nlt tag="relevance.whatsNew"/> </div>
	</ssf:param>
		<jsp:include page="/WEB-INF/jsp/forum/relevance_dashboard/whats_new.jsp" />
	</ssf:canvas>
