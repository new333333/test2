...
<%
	...
	if (item != null) {
		...
		} else if (itemType.equals("profileSkypeId")) {
			%><jsp:include page="/WEB-INF/jsp/definition_elements/mobile/view_profile_attribute.jsp" /><%
		} else  {
			%><%@ include file="/WEB-INF/jsp/definition_elements/mobile/profile_text_item.jsp" %><%
		}
	}
%>
