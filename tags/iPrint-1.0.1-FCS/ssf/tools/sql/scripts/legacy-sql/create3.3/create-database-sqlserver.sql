...
create table SS_Forums (id numeric(19,0) identity not null, type varchar(16) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) not null, library tinyint null, deleted tinyint null, uniqueTitles tinyint null, logVersion numeric(19,0) null, mirrored tinyint null, binderCount int null, resourceDriverName varchar(64) null, resourcePath nvarchar(1024) null, parentBinder numeric(19,0) null, owner numeric(19,0) null, name nvarchar(128) null, pathName nvarchar(1024) null, notify_teamOn tinyint null, notify_style int null, notify_email ntext null, notify_fromAddress nvarchar(128) null, notify_subject nvarchar(128) null, posting char(32) null, properties image null, functionMembershipInherited tinyint not null, definitionsInherited tinyint null, definitionType int null, teamMembershipInherited tinyint null, ratings_average double precision null, ratings_count numeric(19,0) null, description_text ntext null, description_format int null, branding ntext null, brandingExt ntext null, title nvarchar(255) null, normalTitle nvarchar(255) null, iconName varchar(64) null, internalId varchar(32) null, nextBinderNumber int null, binder_level int null, binder_sortKey varchar(255) null unique, versionsEnabled tinyint null, versionsToKeep numeric(19,0) null, versionAgingDays numeric(19,0) null, versionAgingEnabled tinyint null, maxFileSize numeric(19,0) null, fileEncryptionEnabled tinyint null, entryDef char(32) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, postingEnabled tinyint null, topFolder numeric(19,0) null, nextEntryNumber int null, entryRootKey char(15) null, preDeleted tinyint null, preDeletedWhen numeric(19,0) null, preDeletedBy numeric(19,0) null, searchTitle nvarchar(255) null, templateTitle nvarchar(128) null, tDescription_text ntext null, tDescription_format int null, primary key (id));
...
create table SS_Principals (id numeric(19,0) identity not null, type varchar(16) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) null, workspaceId numeric(19,0) null, internalId varchar(32) null, deleted tinyint null, disabled tinyint null, logVersion numeric(19,0) null, emailAddress varchar(24) null, name nvarchar(128) null, foreignName nvarchar(255) null, ldapGuid varchar(128) null, theme varchar(64) null, parentBinder numeric(19,0) null, description_text ntext null, description_format int null, title nvarchar(255) null, normalTitle nvarchar(255) null, iconName varchar(64) null, definitionType int null, entryDef char(32) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, diskQuota numeric(19,0) null, fileSizeLimit numeric(19,0) null, dynamic tinyint null, ldapQuery ntext null, displayStyle varchar(16) null, loginDate datetime null, firstName nvarchar(64) null, lastName nvarchar(64) null, middleName nvarchar(64) null, organization nvarchar(256) null, phone varchar(128) null, zonName nvarchar(100) null, skypeId nvarchar(64) null, twitterId nvarchar(64) null, status nvarchar(256) null, statusDate datetime null, miniBlogId numeric(19,0) null, maxGroupsQuota numeric(19,0) null, maxGroupsFileSizeLimit numeric(19,0) null, diskSpaceUsed numeric(19,0) null, password varchar(64) null, pwdenc varchar(32) null, timeZone varchar(80) null, locale varchar(32) null, digestSeed numeric(19,0) null, postUrl nvarchar(256) null, timeout int null, trusted tinyint null, maxIdleTime int null, sameAddrPolicy tinyint null, primary key (id), unique (zoneId, name), unique (zoneId, foreignName));
...
create table JBPM_LOG (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, INDEX_ int null, DATE_ datetime null, TOKEN_ numeric(19,0) null, PARENT_ numeric(19,0) null, SWIMLANEINSTANCE_ numeric(19,0) null, TASKINSTANCE_ numeric(19,0) null, TASKOLDACTORID_ varchar(255) null, TASKACTORID_ varchar(255) null, CHILD_ numeric(19,0) null, TRANSITION_ numeric(19,0) null, NODE_ numeric(19,0) null, ENTER_ datetime null, LEAVE_ datetime null, DURATION_ numeric(19,0) null, EXCEPTION_ varchar(4000) null, ACTION_ numeric(19,0) null, NEWLONGVALUE_ numeric(19,0) null, SOURCENODE_ numeric(19,0) null, DESTINATIONNODE_ numeric(19,0) null, MESSAGE_ varchar(4000) null, VARIABLEINSTANCE_ numeric(19,0) null, OLDSTRINGIDCLASS_ varchar(255) null, OLDSTRINGIDVALUE_ varchar(255) null, NEWSTRINGIDCLASS_ varchar(255) null, NEWSTRINGIDVALUE_ varchar(255) null, OLDLONGIDCLASS_ varchar(255) null, OLDLONGIDVALUE_ numeric(19,0) null, NEWLONGIDCLASS_ varchar(255) null, NEWLONGIDVALUE_ numeric(19,0) null, OLDSTRINGVALUE_ varchar(4000) null, NEWSTRINGVALUE_ varchar(4000) null, OLDDOUBLEVALUE_ double precision null, NEWDOUBLEVALUE_ double precision null, OLDDATEVALUE_ datetime null, NEWDATEVALUE_ datetime null, OLDLONGVALUE_ numeric(19,0) null, OLDBYTEARRAY_ numeric(19,0) null, NEWBYTEARRAY_ numeric(19,0) null, primary key (ID_));
