...
<c:set var="tag" value="move.folderEntries"/>
<c:if test="${ssOperation != 'move'}">
  <c:set var="tag" value="copy.folderEntries"/>
</c:if>
<jsp:useBean id="tag" type="java.lang.String" />
...
<br/>
<form class="ss_style ss_form" method="post" name="delete_entries_form" id="delete_entries_form"> 
...
<ssf:tree treeName="${wsTreeName}"
	treeDocument="${ssWsDomTree}"  
 	rootOpen="true"
	singleSelect="" 
	singleSelectName="destination_folder_id" />
