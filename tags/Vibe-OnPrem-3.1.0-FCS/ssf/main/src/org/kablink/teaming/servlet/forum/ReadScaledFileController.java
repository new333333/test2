...
public class ReadScaledFileController extends AbstractReadFileController {
	...
	protected ModelAndView handleRequestAfterValidation(HttpServletRequest request,
		...
		// Assuming that the full request URL was http://localhost:8080/ssf/s/readScaled/entityType/entryId/fileId/fileTime/fileVersion/filename.ext
		...
		//We expect the url to be formatted as /readScaled/entityType/entryId/fileId/fileTime/fileVersion/filename.ext
