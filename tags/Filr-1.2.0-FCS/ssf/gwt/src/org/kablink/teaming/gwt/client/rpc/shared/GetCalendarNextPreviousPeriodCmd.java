 ...
 * 'Get Calendar Next/Previous Period' command.
 * 
 * @author drfoster@novell.com
 */
public class GetCalendarNextPreviousPeriodCmd extends VibeRpcCmd {
	 ...
	 */
	private GetCalendarNextPreviousPeriodCmd() {
		super();
	}
	 ...
	 * @param next
	 */
	public GetCalendarNextPreviousPeriodCmd(long browserTZOffset, Long folderId, CalendarDisplayDataRpcResponseData calendarDisplayData, boolean next) {
	 ...
	 * @return
	 */
	public boolean                            getNext()                {return m_next;               }
	 ...
	 * @param
	 */
	public void setNext(               boolean                            next)                {m_next                = next;               }
	...
	public int getCmdType() {
		return VibeRpcCmdType.GET_CALENDAR_NEXT_PREVIOUS_PERIOD.ordinal();
	}
}
