 ...
 * 'create dummy mobile devices' command.
 * 
 * @author drfoster@novell.com
 */
public class CreateDummyMobileDevicesCmd extends VibeRpcCmd {
	private int		m_count;	//
	 ...
	 * constructor.
	 */
	public CreateDummyMobileDevicesCmd() {
	 ...
	 * @param count
	 */
	public CreateDummyMobileDevicesCmd(Long userId, int count) {
	 ...
	 * @param userId
	 */
	public CreateDummyMobileDevicesCmd(Long userId) {
		// Initialize the this object.
		this(userId, 1);
	}
	...
	public int getCmdType() {
		return VibeRpcCmdType.CREATE_DUMMY_MOBILE_DEVICES.ordinal();
	}
}
