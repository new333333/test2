			...
			<div id="termsBlock">
				...
				<div id="termsContainer" class="gwt-CheckBox" style="display: none; float: left;">
					<div>
						...
						<label id="acceptTermsAnchor" style="font-size:12px !important; margin-top: -2px;"><ssf:nlt tag="loginDlg.iAccept" /> <span style="cursor: pointer; color: #fff; text-decoration: underline;"><ssf:nlt tag="loginDlg.termsAndConditions" /></span></label>
					</div>
				</div>
			</div>
