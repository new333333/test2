...
/**
 * The InvokeReplyEvent is used to invoke the 'reply to entry' UI.
 * 
 * @author drfoster@novell.com
 */
public class InvokeReplyEvent extends VibeEventBase<InvokeReplyEvent.Handler> {
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.INVOKE_REPLY;
	}
