...
create table SS_TokenInfo (id char(32) not null, type char(1) not null, zoneId numeric(19,0) null, seed varchar(128) null, lastAccessTime datetime null, userId numeric(19,0) null, applicationId numeric(19,0) null, binderId numeric(19,0) null, binderAccessConstraints int null, clientAddr varchar(128) null, primary key (id));
...
create table JBPM_LOG (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, INDEX_ int null, DATE_ datetime null, TOKEN_ numeric(19,0) null, PARENT_ numeric(19,0) null, SWIMLANEINSTANCE_ numeric(19,0) null, TASKINSTANCE_ numeric(19,0) null, TASKACTORID_ varchar(255) null, TASKOLDACTORID_ varchar(255) null, CHILD_ numeric(19,0) null, VARIABLEINSTANCE_ numeric(19,0) null, OLDBYTEARRAY_ numeric(19,0) null, NEWBYTEARRAY_ numeric(19,0) null, OLDSTRINGIDCLASS_ varchar(255) null, OLDSTRINGIDVALUE_ varchar(255) null, NEWSTRINGIDCLASS_ varchar(255) null, NEWSTRINGIDVALUE_ varchar(255) null, OLDDATEVALUE_ datetime null, NEWDATEVALUE_ datetime null, OLDSTRINGVALUE_ varchar(4000) null, NEWSTRINGVALUE_ varchar(4000) null, OLDLONGVALUE_ numeric(19,0) null, NEWLONGVALUE_ numeric(19,0) null, TRANSITION_ numeric(19,0) null, OLDDOUBLEVALUE_ double precision null, NEWDOUBLEVALUE_ double precision null, EXCEPTION_ varchar(4000) null, ACTION_ numeric(19,0) null, SOURCENODE_ numeric(19,0) null, DESTINATIONNODE_ numeric(19,0) null, OLDLONGIDCLASS_ varchar(255) null, OLDLONGIDVALUE_ numeric(19,0) null, NEWLONGIDCLASS_ varchar(255) null, NEWLONGIDVALUE_ numeric(19,0) null, MESSAGE_ varchar(4000) null, NODE_ numeric(19,0) null, ENTER_ datetime null, LEAVE_ datetime null, DURATION_ numeric(19,0) null, primary key (ID_));
create table JBPM_MESSAGE (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, DESTINATION_ varchar(255) null, EXCEPTION_ varchar(4000) null, ISSUSPENDED_ tinyint null, TOKEN_ numeric(19,0) null, TEXT_ nvarchar(255) null, TRANSITIONNAME_ nvarchar(255) null, TASKINSTANCE_ numeric(19,0) null, ACTION_ numeric(19,0) null, NODE_ numeric(19,0) null, primary key (ID_));
...
CREATE TABLE SSQRTZ_CALENDARS (  CALENDAR_NAME VARCHAR (200)  NOT NULL ,  CALENDAR IMAGE NOT NULL,  PRIMARY KEY (CALENDAR_NAME));
CREATE TABLE SSQRTZ_CRON_TRIGGERS (  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  CRON_EXPRESSION VARCHAR (120)  NOT NULL ,  TIME_ZONE_ID VARCHAR (80),  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_FIRED_TRIGGERS (  ENTRY_ID VARCHAR (95)  NOT NULL ,  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  IS_VOLATILE VARCHAR (1)  NOT NULL ,  INSTANCE_NAME VARCHAR (200)  NOT NULL ,  FIRED_TIME BIGINT NOT NULL ,  PRIORITY INTEGER NOT NULL ,  STATE VARCHAR (16)  NOT NULL,  JOB_NAME VARCHAR (200)  NULL ,  JOB_GROUP VARCHAR (200)  NULL ,  IS_STATEFUL VARCHAR (1)  NULL ,  REQUESTS_RECOVERY VARCHAR (1)  NULL,  PRIMARY KEY (ENTRY_ID));
CREATE TABLE SSQRTZ_PAUSED_TRIGGER_GRPS (  TRIGGER_GROUP VARCHAR (200)  NOT NULL,  PRIMARY KEY (TRIGGER_GROUP));
CREATE TABLE SSQRTZ_SCHEDULER_STATE (  INSTANCE_NAME VARCHAR (200)  NOT NULL ,  LAST_CHECKIN_TIME BIGINT NOT NULL ,  CHECKIN_INTERVAL BIGINT NOT NULL ,PRIMARY KEY (INSTANCE_NAME));
CREATE TABLE SSQRTZ_LOCKS (  LOCK_NAME VARCHAR (40)  NOT NULL,PRIMARY KEY (LOCK_NAME));
CREATE TABLE SSQRTZ_JOB_DETAILS (  JOB_NAME VARCHAR (200)  NOT NULL ,  JOB_GROUP VARCHAR (200)  NOT NULL ,  DESCRIPTION VARCHAR (250) NULL ,  JOB_CLASS_NAME VARCHAR (250)  NOT NULL ,  IS_DURABLE VARCHAR (1)  NOT NULL ,  IS_VOLATILE VARCHAR (1)  NOT NULL ,  IS_STATEFUL VARCHAR (1)  NOT NULL ,  REQUESTS_RECOVERY VARCHAR (1)  NOT NULL ,  JOB_DATA IMAGE NULL,  PRIMARY KEY (JOB_NAME,JOB_GROUP));
CREATE TABLE SSQRTZ_JOB_LISTENERS (  JOB_NAME VARCHAR (200)  NOT NULL ,  JOB_GROUP VARCHAR (200)  NOT NULL ,  JOB_LISTENER VARCHAR (200)  NOT NULL,  PRIMARY KEY (JOB_NAME,JOB_GROUP,JOB_LISTENER));
CREATE TABLE SSQRTZ_SIMPLE_TRIGGERS (  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  REPEAT_COUNT BIGINT NOT NULL ,  REPEAT_INTERVAL BIGINT NOT NULL ,  TIMES_TRIGGERED BIGINT NOT NULL,  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_BLOB_TRIGGERS (  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  BLOB_DATA IMAGE NULL,  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_TRIGGER_LISTENERS (  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  TRIGGER_LISTENER VARCHAR (200)  NOT NULL,  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP,TRIGGER_LISTENER));
CREATE TABLE SSQRTZ_TRIGGERS (  TRIGGER_NAME VARCHAR (200)  NOT NULL ,  TRIGGER_GROUP VARCHAR (200)  NOT NULL ,  JOB_NAME VARCHAR (200)  NOT NULL ,  JOB_GROUP VARCHAR (200)  NOT NULL ,  IS_VOLATILE VARCHAR (1)  NOT NULL ,  DESCRIPTION VARCHAR (250) NULL ,  NEXT_FIRE_TIME BIGINT NULL ,  PREV_FIRE_TIME BIGINT NULL ,  PRIORITY INTEGER NULL ,  TRIGGER_STATE VARCHAR (16)  NOT NULL ,  TRIGGER_TYPE VARCHAR (8)  NOT NULL ,  START_TIME BIGINT NOT NULL ,  END_TIME BIGINT NULL ,  CALENDAR_NAME VARCHAR (200)  NULL ,  MISFIRE_INSTR SMALLINT NULL,  JOB_DATA IMAGE NULL,  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP));
