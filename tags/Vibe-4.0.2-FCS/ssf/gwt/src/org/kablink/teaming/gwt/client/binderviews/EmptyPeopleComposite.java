...
/**
 * Class that holds the widget displayed for an empty people view.
 * 
 * @author drfoster@novell.com
 */
public class EmptyPeopleComposite extends ResizeComposite {
	...
	private void createContent() {
		...
		m_rootPanel.add(fp);
		fp.getElement().setInnerText(m_messages.peopleList());

		// ...generate the sub header...
		fp = new VibeFlowPanel();
		fp.addStyleName("vibe-emptyWidget-headSub");
		m_rootPanel.add(fp);
		fp.getElement().setInnerText(m_messages.emptyPeople_SubHead());

		// ...generate the main body of information...
		fp = new VibeFlowPanel();
		fp.addStyleName("vibe-emptyWidget-info");
		m_rootPanel.add(fp);
		fp.getElement().setInnerText(m_messages.emptyPeople_Info_1(m_company, m_product));

		fp = new VibeFlowPanel();
		fp.addStyleName("vibe-emptyWidget-info");
		m_rootPanel.add(fp);
		fp.getElement().setInnerText(m_messages.emptyPeople_Info_2(m_company, m_product));
	}
}
