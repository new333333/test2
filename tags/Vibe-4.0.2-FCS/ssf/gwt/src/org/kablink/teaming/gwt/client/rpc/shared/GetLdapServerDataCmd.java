 ...
 * 'get ldap server data' command.
 * 
 * @author drfoster@novell.com
 */
public class GetLdapServerDataCmd extends VibeRpcCmd {
	 ...
	 * @param searchInfo
	 */
	public GetLdapServerDataCmd(DirectoryServer directoryServer, LdapSearchInfo searchInfo) {
	...
	public LdapSearchInfo  getSearchInfo()      {return m_searchInfo;     }
	...
	public void setSearchInfo(     LdapSearchInfo  searchInfo)      {m_searchInfo      = searchInfo;     }
	...
	public int getCmdType() {
		return VibeRpcCmdType.GET_LDAP_SERVER_DATA.ordinal();
	}
}
