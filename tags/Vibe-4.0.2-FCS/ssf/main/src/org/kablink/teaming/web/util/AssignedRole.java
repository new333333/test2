...
public class AssignedRole {
    public enum RoleType implements IsSerializable
    {
        ...
        ShareFolderExternal (ObjectKeys.FUNCTION_ALLOW_FOLDER_SHARING_EXTERNAL_INTERNALID, true, false),
        ShareFolderForward (ObjectKeys.FUNCTION_ALLOW_FOLDER_SHARING_FORWARD_INTERNALID, true, false),
        ShareFolderInternal (ObjectKeys.FUNCTION_ALLOW_FOLDER_SHARING_INTERNAL_INTERNALID, true, false),
        ShareFolderPublic (ObjectKeys.FUNCTION_ALLOW_FOLDER_SHARING_PUBLIC_INTERNALID, true, false),
