 ...
 * @author hurley
 */
public class UserIdNotActiveException extends AuthenticationException {
	 ...
	 * 
	 */
	public UserIdNotActiveException(String msg) {
		super(msg);
	}
	
	/*
	 * Returns the ApiErrorCode stored in this exception.
	 */
	...
	/**
	 * Returns any user ID stored in this exception.
	 * 
	 * @return
	 */
	...
	/**
	 * Stores a user ID in this exception.
	 * 
	 * @param userId
	 */
