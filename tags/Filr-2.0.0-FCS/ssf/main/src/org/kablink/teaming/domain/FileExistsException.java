 ...
 *
 */
public class FileExistsException extends UncheckedCodedException implements NoStackTrace {
	private static final String FileExistsException_ErrorCode = "entry.duplicateFileInLibrary";
    public FileExistsException(String fileName) {
    	super(FileExistsException_ErrorCode, new Object[]{fileName});
    }
	...
	public ApiErrorCode getApiErrorCode() {
		return ApiErrorCode.FILE_EXISTS;
	}
}
