...
/**
 * The InvokeEditShareRightsDlgEvent is used to invoke the "edit share rights"
 * 
...
public class InvokeEditShareRightsDlgEvent extends VibeEventBase<InvokeEditShareRightsDlgEvent.Handler>
{
	...
	{
		void onInvokeEditShareRightsDlg( InvokeEditShareRightsDlgEvent event );
	}
    ...
    {
        handler.onInvokeEditShareRightsDlg( this );
    }
	...
	{
		return TeamingEvents.INVOKE_EDIT_SHARE_RIGHTS_DLG;
	}
