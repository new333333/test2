 ...
 * 'Trash Purge All' command.
 * 
 * @author drfoster@novell.com
 */
public class TrashPurgeAllCmd extends VibeRpcCmd {
	 ...
	 * @param binderId
	 */
	public TrashPurgeAllCmd(Long binderId, boolean purgeMirroredSources) {
		this();
	...
	public int getCmdType() {
		return VibeRpcCmdType.TRASH_PURGE_ALL.ordinal();
	}
}
