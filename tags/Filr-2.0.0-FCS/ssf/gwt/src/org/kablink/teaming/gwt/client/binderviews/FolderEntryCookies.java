...
/**
 * Utility methods for managing cookies for the folder entry viewer.
 * 
 * @author drfoster@novell.com
 */
public class FolderEntryCookies {
	/**
	 * Enumeration used to manage the cookies stored for the folder
	 * entry viewer.
	 */
	public enum Cookie {
		COMMENTS_VISIBLE,
		 ...
		 */
		private String getCookieName(EntityId eid) {
			return ("feView:" + name() + ":" + eid.getBinderId() + ":" + eid.getEntityId());
		}
	}
