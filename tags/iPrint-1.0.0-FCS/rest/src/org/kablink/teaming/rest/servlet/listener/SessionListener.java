 ...
 */
package org.kablink.teaming.rest.servlet.listener;
...
public class SessionListener implements HttpSessionListener {
	...
	public void sessionCreated(HttpSessionEvent se) {
		...
		// We designed "rest" webapp to be stateless in that it should never create HTTP sessions.
		// If this method is ever executed, it means that something is wrong either with the software
