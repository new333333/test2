...
/**
 * The InvokeDropBoxEvent is used to invoke Vibe's drop box (i.e., the
 * file drag&drop applet.)
 * 
...
public class InvokeDropBoxEvent extends VibeEventBase<InvokeDropBoxEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onInvokeDropBox(InvokeDropBoxEvent event);
	}
	
	/**
	 * Class constructor.
	 */
	public InvokeDropBoxEvent() {
		super();
	}
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.INVOKE_DROPBOX;
	}
