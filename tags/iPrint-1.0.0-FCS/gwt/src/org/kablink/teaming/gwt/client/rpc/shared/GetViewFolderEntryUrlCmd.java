...
/**
 * This class holds all of the information necessary to execute the "get view folder entry url" command.
 * 
 * @author jwootton
 *
 */
public class GetViewFolderEntryUrlCmd extends VibeRpcCmd
{
