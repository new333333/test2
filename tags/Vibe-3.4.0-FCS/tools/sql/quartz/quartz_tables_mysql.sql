...
ALTER TABLE SSQRTZ_JOB_LISTENERS DROP FOREIGN KEY FK_SSQRTZ_JOB_LISTENERS_SSQRTZ_JOB_DETAILS;
ALTER TABLE SSQRTZ_TRIGGERS DROP FOREIGN KEY FK_SSQRTZ_TRIGGERS_SSQRTZ_JOB_DETAILS;
ALTER TABLE SSQRTZ_CRON_TRIGGERS DROP FOREIGN KEY FK_SSQRTZ_CRON_TRIGGERS_SSQRTZ_TRIGGERS;
ALTER TABLE SSQRTZ_SIMPLE_TRIGGERS DROP FOREIGN KEY FK_SSQRTZ_SIMPLE_TRIGGERS_SSQRTZ_TRIGGERS;
ALTER TABLE SSQRTZ_BLOB_TRIGGERS DROP FOREIGN KEY FK_SSQRTZ_BLOB_TRIGGERS_SSQRTZ_TRIGGERS;
ALTER TABLE SSQRTZ_TRIGGER_LISTENERS DROP FOREIGN KEY FK_SSQRTZ_TRIGGER_LISTENERS_SSQRTZ_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_JOB_LISTENERS;
DROP TABLE IF EXISTS SSQRTZ_TRIGGER_LISTENERS;
DROP TABLE IF EXISTS SSQRTZ_FIRED_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_PAUSED_TRIGGER_GRPS;
DROP TABLE IF EXISTS SSQRTZ_SCHEDULER_STATE;
DROP TABLE IF EXISTS SSQRTZ_LOCKS;
DROP TABLE IF EXISTS SSQRTZ_SIMPLE_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_CRON_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_BLOB_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_TRIGGERS;
DROP TABLE IF EXISTS SSQRTZ_JOB_DETAILS;
DROP TABLE IF EXISTS SSQRTZ_CALENDARS;
