...
create table SS_Principals (id numeric(19,0) identity not null, type varchar(16) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) null, workspaceId numeric(19,0) null, internalId varchar(32) null, deleted tinyint null, disabled tinyint null, logVersion numeric(19,0) null, emailAddress varchar(24) null, name nvarchar(128) null, foreignName nvarchar(128) null, theme varchar(64) null, parentBinder numeric(19,0) null, description_text ntext null, description_format int null, title nvarchar(255) null, normalTitle nvarchar(255) null, iconName varchar(64) null, definitionType int null, entryDef char(32) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, displayStyle varchar(16) null, loginDate datetime null, firstName nvarchar(64) null, lastName nvarchar(64) null, middleName nvarchar(64) null, organization nvarchar(256) null, phone varchar(128) null, zonName nvarchar(100) null, skypeId nvarchar(64) null, twitterId nvarchar(64) null, status nvarchar(256) null, statusDate datetime null, miniBlogId numeric(19,0) null, password varchar(64) null, timeZone varchar(80) null, locale varchar(32) null, digestSeed numeric(19,0) null, postUrl nvarchar(256) null, timeout int null, trusted tinyint null, maxIdleTime int null, sameAddrPolicy tinyint null, primary key (id), unique (zoneId, foreignName), unique (zoneId, name));
...
create table JBPM_LOG (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, INDEX_ int null, DATE_ datetime null, TOKEN_ numeric(19,0) null, PARENT_ numeric(19,0) null, SWIMLANEINSTANCE_ numeric(19,0) null, TASKINSTANCE_ numeric(19,0) null, TRANSITION_ numeric(19,0) null, CHILD_ numeric(19,0) null, NODE_ numeric(19,0) null, ENTER_ datetime null, LEAVE_ datetime null, DURATION_ numeric(19,0) null, EXCEPTION_ varchar(4000) null, ACTION_ numeric(19,0) null, NEWLONGVALUE_ numeric(19,0) null, TASKACTORID_ varchar(255) null, MESSAGE_ varchar(4000) null, TASKOLDACTORID_ varchar(255) null, VARIABLEINSTANCE_ numeric(19,0) null, OLDLONGIDCLASS_ varchar(255) null, OLDLONGIDVALUE_ numeric(19,0) null, NEWLONGIDCLASS_ varchar(255) null, NEWLONGIDVALUE_ numeric(19,0) null, OLDBYTEARRAY_ numeric(19,0) null, NEWBYTEARRAY_ numeric(19,0) null, OLDDOUBLEVALUE_ double precision null, NEWDOUBLEVALUE_ double precision null, OLDDATEVALUE_ datetime null, NEWDATEVALUE_ datetime null, OLDSTRINGVALUE_ varchar(4000) null, NEWSTRINGVALUE_ varchar(4000) null, OLDLONGVALUE_ numeric(19,0) null, SOURCENODE_ numeric(19,0) null, DESTINATIONNODE_ numeric(19,0) null, OLDSTRINGIDCLASS_ varchar(255) null, OLDSTRINGIDVALUE_ varchar(255) null, NEWSTRINGIDCLASS_ varchar(255) null, NEWSTRINGIDVALUE_ varchar(255) null, primary key (ID_));
