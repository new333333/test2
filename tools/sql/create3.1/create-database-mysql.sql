...
create table SS_Principals (id bigint not null auto_increment, type varchar(16) not null, lockVersion bigint not null, zoneId bigint, workspaceId bigint, internalId varchar(32), deleted bit, disabled bit, logVersion bigint, emailAddress varchar(24), name varchar(128), foreignName varchar(128), ldapGuid varchar(128), theme varchar(64), parentBinder bigint, description_text longtext, description_format integer, title varchar(255), normalTitle varchar(255), iconName varchar(64), definitionType integer, entryDef char(32), creation_date datetime, creation_principal bigint, modification_date datetime, modification_principal bigint, diskQuota bigint, displayStyle varchar(16), loginDate datetime, firstName varchar(64), lastName varchar(64), middleName varchar(64), organization varchar(256), phone varchar(128), zonName varchar(100), skypeId varchar(64), twitterId varchar(64), status varchar(256), statusDate datetime, miniBlogId bigint, maxGroupsQuota bigint, diskSpaceUsed bigint, password varchar(64), pwdenc varchar(32), timeZone varchar(80), locale varchar(32), digestSeed bigint, postUrl varchar(256), timeout integer, trusted bit, maxIdleTime integer, sameAddrPolicy bit, primary key (id), unique (zoneId, name), unique (zoneId, foreignName)) ENGINE=InnoDB;
...
create table JBPM_LOG (ID_ bigint not null auto_increment, CLASS_ char(1) not null, INDEX_ integer, DATE_ datetime, TOKEN_ bigint, PARENT_ bigint, SWIMLANEINSTANCE_ bigint, TASKINSTANCE_ bigint, TRANSITION_ bigint, SOURCENODE_ bigint, DESTINATIONNODE_ bigint, EXCEPTION_ varchar(4000), ACTION_ bigint, NODE_ bigint, ENTER_ datetime, LEAVE_ datetime, DURATION_ bigint, TASKACTORID_ varchar(255), TASKOLDACTORID_ varchar(255), CHILD_ bigint, VARIABLEINSTANCE_ bigint, OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDBYTEARRAY_ bigint, NEWBYTEARRAY_ bigint, OLDSTRINGIDCLASS_ varchar(255), OLDSTRINGIDVALUE_ varchar(255), NEWSTRINGIDCLASS_ varchar(255), NEWSTRINGIDVALUE_ varchar(255), OLDLONGVALUE_ bigint, NEWLONGVALUE_ bigint, OLDSTRINGVALUE_ varchar(4000), NEWSTRINGVALUE_ varchar(4000), OLDLONGIDCLASS_ varchar(255), OLDLONGIDVALUE_ bigint, NEWLONGIDCLASS_ varchar(255), NEWLONGIDVALUE_ bigint, OLDDATEVALUE_ datetime, NEWDATEVALUE_ datetime, MESSAGE_ varchar(4000), primary key (ID_)) ENGINE=InnoDB;
create table JBPM_MESSAGE (ID_ bigint not null auto_increment, CLASS_ char(1) not null, DESTINATION_ varchar(255), EXCEPTION_ varchar(4000), ISSUSPENDED_ bit, TOKEN_ bigint, TEXT_ varchar(255), TRANSITIONNAME_ varchar(255), TASKINSTANCE_ bigint, NODE_ bigint, ACTION_ bigint, primary key (ID_)) ENGINE=InnoDB;
