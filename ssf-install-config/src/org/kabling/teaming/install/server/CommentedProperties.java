...
/**
 * The CommentedProperties class is an extension of java.util.Properties to allow retention of comment lines and blank (whitespace only)
 * lines in the properties file.
 * 
 * http://www.dreamincode.net/forums/topic/53734-java-code-to-modify-properties-file-and-preserve-comments/ Written for Java version 1.4
 */
public class CommentedProperties extends java.util.Properties
{
	...
	/**
	 * Need this method from Properties because original code has StringBuilder, which is an element of Java 1.5, used StringBuffer instead
	 * (because this code was written for Java 1.4)
	 * 
	 * @param str
