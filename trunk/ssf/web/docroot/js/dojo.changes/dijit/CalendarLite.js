	...
	var CalendarLite = declare("dijit.CalendarLite", [_WidgetBase, _TemplatedMixin], {
		...
		buildRendering: function(){
			...
			if (calLang) {
				...
				//    to track down why and this is a simple hack to
				//    ensure the correct value is used.  As of
				//    20150817, I had tested this for all French
				//    locales.
				if      (calLang == "fr")    calLang = "fr-fr";
				else if (calLang == "fr-fr") calLang = "fr";
				if		(calLang == "es")	 calLang = "es-es";
				else if	(calLang == "es-es") calLang = "es";
			}
			// Markup for days of the week (referenced from template)
			var d = this.dowTemplateString,
				dayNames = this.dateLocaleModule.getNames('days', this.dayWidth, 'standAlone', calLang),
				dayOffset = cldrSupplemental.getFirstDayOfWeek(calLang);
