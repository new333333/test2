...
<ul id="ss_folderMenuShowEntryLink_<%= linkMenuIdx %>" name="ss_folderMenuShowEntryLink_<%= linkMenuIdx %>"><li><a href="javascript:;" onClick="<%= linkMenuObj %>.showEntry(); return false;">
