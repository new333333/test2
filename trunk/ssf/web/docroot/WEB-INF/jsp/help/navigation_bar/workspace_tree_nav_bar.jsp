...
<p><ssf:nlt tag="help.workspaceTreePortlet.using"><ssf:param name="value" value="${ssProductTitle}"/></ssf:nlt> <ssf:nlt tag="help.workspaceTreePortlet.using.displayPlace"><ssf:param name="value" value="${ssProductTitle}"/></ssf:nlt></p>
...
<p><a target="ss_new" href="<html:rootPath/>help/${ssUser.locale}/pdfs/ICEcore Quick Start Guide.pdf"><ssf:nlt tag="help.viewBooks.content.listItem.quickStart"><ssf:param name="value" value="${ssProductTitle}"/></ssf:nlt> <ssf:nlt tag="help.globalStrings.newWindow"/></a></p>
