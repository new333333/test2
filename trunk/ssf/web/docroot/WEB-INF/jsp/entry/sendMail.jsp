...
<form class="ss_style ss_form" method="post" 
  onSubmit="return ss_onSubmit(this);"
    action="<ssf:url action="send_entry_email" actionUrl="true" binderId="${ssBinder.id}"
...
<table class="ss_style"  border ="0" cellspacing="0" cellpadding="0">
 <tr>
  <td>
   ...
   <input tabindex="1" class="ss_style" type="text" name="addresses" id="addresses" size="86" value="">
   <br /><br />
 <input tabindex="2" type="checkbox" name="self" id="self" class="ss_style" >&nbsp;<span class="ss_labelRight">
...
<table class="ss_style"  border ="0" cellspacing="0" cellpadding="0">
 <tr>
  <td>
   ...
   <input tabindex="6" class="ss_style" type="text" name="subject" id="subject" size="86" value="${ssEntry.docNumber}. ${ssEntry.title}">
</td></tr>
<tr><td>
   <span class="ss_labelAbove ss_bold"><ssf:nlt tag="sendMail.message"/></span>
   <textarea tabindex="7" class="ss_style mceEditable" rows="20" cols="80"
  name="body">
...
<tr><td>
 <input tabindex="8" type="checkbox" name="attachments" id="attachments" class="ss_style" >&nbsp;<span class="ss_labelRight">
