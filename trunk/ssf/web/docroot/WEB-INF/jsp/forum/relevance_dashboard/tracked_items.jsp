...
<div id="ss_dashboard_content" class="ss_tricolumn">
  <div class="ss_colmid">
	...
	<ssf:param name="title" useBody="true" >
		<div id="ss_title" class="ss_pt_title"> <ssf:nlt tag="relevance.trackedFolders"/> </div>
	</ssf:param>
...
<c:forEach var="binder" items="${ss_trackedBinders}">
  <c:if test="${binder.entityType == 'folder'}">
	...
	<ssf:param name="title" useBody="true" >
		<div id="ss_title" class="ss_pt_title"> <ssf:nlt tag="relevance.trackedWorkspaces"/> </div>
	</ssf:param>
