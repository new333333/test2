    	...
    	if(claimedIdentityRegexs != null) {
    		for(String claimedIdentityRegex:claimedIdentityRegexs) {
    			...
    			if(claimedIdentity.matches(claimedIdentityRegex))
    				return claimedIdentity; // Match found - This claimed identity passes the test.
    		}
    	}
    	throw new AuthenticationServiceException("Unable to accept claimed identity '" + claimedIdentity + "'");
    }
