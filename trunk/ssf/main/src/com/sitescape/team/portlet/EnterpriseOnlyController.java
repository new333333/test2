 ...
 */
package com.sitescape.team.portlet;
...
public class EnterpriseOnlyController extends SAbstractController {
	public ModelAndView handleRenderRequestInternal(RenderRequest request, 
			RenderResponse response) throws Exception {
		return new ModelAndView(WebKeys.VIEW_ENTERPRISE_ONLY);
	}
}
