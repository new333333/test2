...
import org.kabling.teaming.install.client.widgets.GwValidator;
 ...
 */
public class ValueRequiredValidator extends GwValidator<TextBox>
{
	 ...
	 *            the txt box
	 */
	public ValueRequiredValidator(TextBox txtBox)
	{
		super(txtBox);
	}
