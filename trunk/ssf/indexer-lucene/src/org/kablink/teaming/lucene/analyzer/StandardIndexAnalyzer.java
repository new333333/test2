 ...
 * SsfTokenFilter} and {@link StopFilter}, using a list of
 * English stop words.
 *
 * <a name="version"/>
 ...
 */
public class StandardIndexAnalyzer extends Analyzer {
  private Set stopSet;
   ...
   */
  public StandardIndexAnalyzer(Version matchVersion, boolean ignoreCaseForStop) {
  ...
  public StandardIndexAnalyzer(Version matchVersion, Set stopWords, boolean ignoreCaseForStop) {
    stopSet = stopWords;
  ...
  public StandardIndexAnalyzer(Version matchVersion, File stopwords, boolean ignoreCaseForStop) throws IOException {
  ...
  public StandardIndexAnalyzer(Version matchVersion, Reader stopwords, boolean ignoreCaseForStop) throws IOException {
    stopSet = WordlistLoader.getWordSet(stopwords);
    this.ignoreCaseForStop = ignoreCaseForStop;
    init(matchVersion);
  }
  ...
  private final void init(Version matchVersion) {
    setOverridesTokenStreamMethod(StandardIndexAnalyzer.class);
  ...
  StandardFilter}, a {@link SsfTokenFilter} and a {@link StopFilter}. */
  ...
  public TokenStream reusableTokenStream(String fieldName, Reader reader) throws IOException {
    ...
    if (streams == null) {
      ...
      streams.filteredTokenStream = new SsfTokenFilter(streams.filteredTokenStream);
      if (useDefaultStopPositionIncrements) {
