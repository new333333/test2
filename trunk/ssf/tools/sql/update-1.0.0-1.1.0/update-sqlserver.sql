...
create table SS_SearchNodeInfo (indexName nvarchar(160) not null, nodeId nvarchar(128) not null, accessMode varchar(16) null, outOfSynch tinyint null, primary key (indexName, nodeId));
