...
create table SS_SearchNodeInfo (indexName varchar(160) not null, nodeId varchar(128) not null, accessMode varchar(16), outOfSynch bit, primary key (indexName, nodeId)) ENGINE=InnoDB;
