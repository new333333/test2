		...
		try
		{
			...
			if ( this.guideName != null )
			{
				...
				if ( this.guideName.equalsIgnoreCase( "user" ) )
				{
					...
					url = SPropsUtil.getString( "help.userGuide", "http://www.novell.com/documentation/teaming30/team30_user/data/" );
				}
				else if ( this.guideName.equalsIgnoreCase( "adv_user" ) )
				{
					// Get the url to the advanced user guide.
					url = SPropsUtil.getString( "help.advancedUserGuide", "http://www.novell.com/documentation/teaming30/team30_useradv/data/" );
				}
				else if ( this.guideName.equalsIgnoreCase( "admin" ) )
				{
					// Get the url to the administration guide.
					url = SPropsUtil.getString( "help.adminGuide", "http://www.novell.com/documentation/teaming30/team30_admin/data/" );
				}
				else
					url = null;
				...
				else
				{
					...
					url = "http://www.novell.com/documentation/teaming30";
				}
