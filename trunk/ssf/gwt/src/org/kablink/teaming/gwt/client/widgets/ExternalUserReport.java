...
import org.kablink.teaming.gwt.client.rpc.shared.CreateExternalUserReportCmd;
 ...
 */
public class ExternalUserReport extends ReportCompositeBase
	implements
		SearchFindResultsEvent.Handler
{
	...
	public void createContent() {
		...
		InlineLabel il = buildInlineLabel(m_messages.externalUserReportCaption1(), "vibe-reportCompositeBase-caption");
		m_rootContent.add(il);
		GwtClientHelper.addBR(m_rootContent, 2);
		il = buildInlineLabel(m_messages.externalUserReportCaption2(), "vibe-reportCompositeBase-caption");
		m_rootContent.add(il);
		...
		ft.setCellSpacing(2);
		fp.add(ft);
		ft.setWidget(0, 0, buildInlineLabel(m_messages.externalUserReportPeople(), "vibe-userActivityReportComposite-peopleLabel"));
		...
		Button removeBtn = new Button(m_messages.externalUserReportRemove());
