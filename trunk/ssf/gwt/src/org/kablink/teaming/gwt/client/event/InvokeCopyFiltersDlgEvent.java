...
/**
 * The InvokeCopyFiltersDlgEvent is used invoke the 'copy filters'
 * dialog.
 * 
...
public class InvokeCopyFiltersDlgEvent extends VibeEventBase<InvokeCopyFiltersDlgEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onInvokeCopyFiltersDlg(InvokeCopyFiltersDlgEvent event);
	}
	...
	protected void doDispatch(Handler handler) {
		handler.onInvokeCopyFiltersDlg(this);
	}
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.INVOKE_COPY_FILTERS_DLG;
	}
