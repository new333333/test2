...
/**
 * Class used to model the priority column in the task folder listing
 * table.  
 * 
 * @author drfoster@novell.com
 */
public class TaskPriorityColumnDefinition extends AbstractColumnDefinition<TaskListItem, String> {
	/**
	...
	public String getCellValue(TaskListItem rowValue) {
		return rowValue.getTask().getPriority();
	}
	...
	public void setCellValue(TaskListItem rowValue, String cellValue) {
		rowValue.getTask().setPriority(cellValue);
	}
}
