...
/**
 * The ClearSelectedUsersAdHocFoldersEvent is used to clear the adHoc
...
public class ClearSelectedUsersAdHocFoldersEvent extends SelectedEntitiesEventBase<ClearSelectedUsersAdHocFoldersEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onClearSelectedUsersAdHocFolders(ClearSelectedUsersAdHocFoldersEvent event);
	}
    ...
    protected void doDispatch(Handler handler) {
        handler.onClearSelectedUsersAdHocFolders(this);
    }    
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.CLEAR_SELECTED_USERS_ADHOC_FOLDERS;
	}
