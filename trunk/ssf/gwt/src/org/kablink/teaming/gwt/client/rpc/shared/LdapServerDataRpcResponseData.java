...
/**
 * This class holds the response data for the 'get ldap server data'
 * command.
 * 
...
public class LdapServerDataRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 * requirements.
	 */
	public LdapServerDataRpcResponseData() {
	 ...
	 * @param queryOutput
	 */
	public LdapServerDataRpcResponseData(QueryOutput<LdapObject> queryOutput) {
