...
/**
 * Class used to model the name column in the task folder listing
 * table.  
 * 
 * @author drfoster@novell.com
 */
public class TaskNameColumnDefinition extends AbstractColumnDefinition<TaskListItem, String> {
	/**
	...
	public String getCellValue(TaskListItem rowValue) {
		return rowValue.getTask().getTitle();
	}

	/**
	 * Implements the AbstractColumnDefinition.setCellValue() method.
	 * 
	 * Note:  Since the name cannot be edited, calls to the setter are
	 * ignored.
	 * 
	 * @param rowValue
	 * @param cellValue
