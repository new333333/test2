			...
			menuItem = new VibeMenuItem(simpleTitle, false, new Command() {
				...
				public void execute() {
					...
					if (hasSimpleUrl) {
						...
						case CLEAR_SELECTED_USERS_PUBLIC_COLLECTION:    event = new ClearSelectedUsersPublicCollectionEvent(  binderId, eid      ); break;
						...
						case DISABLE_SELECTED_USERS_PUBLIC_COLLECTION:  event = new DisableSelectedUsersPublicCollectionEvent(binderId, eid      ); break;
						...
						case ENABLE_SELECTED_USERS_PUBLIC_COLLECTION:   event = new EnableSelectedUsersPublicCollectionEvent( binderId, eid      ); break;
