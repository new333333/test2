...
/**
 * Class used to model the closed/% done column in the task folder
 * listing table.  
 * 
 * @author drfoster@novell.com
 */
public class TaskClosedCompletedColumnDefinition extends AbstractColumnDefinition<TaskListItem, String> {
	/**
	...
	public String getCellValue(TaskListItem rowValue) {
		return rowValue.getTask().getCompleted();
	}
