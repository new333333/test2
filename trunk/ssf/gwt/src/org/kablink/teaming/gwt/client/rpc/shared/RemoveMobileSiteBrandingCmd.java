...
/**
 * This class represents the 'Remove mobile application site branding'
 * command.
 * 
 * @author drfoster@novell.com
 */
public class RemoveMobileSiteBrandingCmd extends VibeRpcCmd {
	 ...
	 */
	public RemoveMobileSiteBrandingCmd() {
	...
	public int getCmdType() {
		return VibeRpcCmdType.REMOVE_MOBILE_SITE_BRANDING.ordinal();
	}
