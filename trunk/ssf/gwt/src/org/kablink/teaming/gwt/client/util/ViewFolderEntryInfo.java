...
public class ViewFolderEntryInfo implements IsSerializable {
	...
	public boolean           isLockedByCurrentUser()                     {return m_lockedByCurrentUser;                     }
	...
	public void setLockedByCurrentUser(boolean           lockedByCurrentUser)                       {m_lockedByCurrentUser = lockedByCurrentUser;           }
