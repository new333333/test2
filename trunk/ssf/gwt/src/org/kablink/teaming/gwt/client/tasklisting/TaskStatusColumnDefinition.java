...
/**
 * Class used to model the status column in the task folder listing
 * table.  
 * 
 * @author drfoster@novell.com
 */
public class TaskStatusColumnDefinition extends AbstractColumnDefinition<TaskListItem, String> {
	/**
	...
	public String getCellValue(TaskListItem rowValue) {
		return rowValue.getTask().getStatus();
	}
	...
	public void setCellValue(TaskListItem rowValue, String cellValue) {
		rowValue.getTask().setStatus(cellValue);
	}
}
