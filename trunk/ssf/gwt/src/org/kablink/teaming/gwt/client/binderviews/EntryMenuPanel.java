		...
		VibeMenuItem menuItem = new VibeMenuItem(menuText, menuTextIsHTML, new Command() {
			...
			public void execute() {
				...
				if (GwtClientHelper.hasString(simpleUrl)) {
					...
					case CLEAR_SELECTED_USERS_PUBLIC_COLLECTION:    event = new ClearSelectedUsersPublicCollectionEvent(  folderId      ); break;
					...
					case DISABLE_SELECTED_USERS_PUBLIC_COLLECTION:  event = new DisableSelectedUsersPublicCollectionEvent(folderId      ); break;
					...
					case ENABLE_SELECTED_USERS_PUBLIC_COLLECTION:   event = new EnableSelectedUsersPublicCollectionEvent( folderId      ); break;
