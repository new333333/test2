...
public class HelpData
{
	...
	private String getLangCode()
	{
		...
		lang = null;
		if ( GwtMainPage.m_requestInfo != null )
			lang = GwtMainPage.m_requestInfo.getLanguage();
