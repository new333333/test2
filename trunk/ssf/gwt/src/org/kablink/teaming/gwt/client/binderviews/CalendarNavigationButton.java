...
/**
 * Class used to implement a calendar navigation button.  
 * 
 * @author drfoster@novell.com
 */
public class CalendarNavigationButton extends Anchor {
	...
	private class ButtonHover implements MouseOverHandler, MouseOutHandler {
		...
		public void onMouseOut(MouseOutEvent me) {
			if (m_enabled) {
				if      (null != m_hoverLabel) m_hoverLabel.removeStyleName("vibe-vibe-calNavButton-widgetTextHover");
		...
		public void onMouseOver(MouseOverEvent me) {
			if (m_enabled) {
				if      (null != m_hoverLabel) m_hoverLabel.addStyleName("vibe-vibe-calNavButton-widgetTextHover");
	 ...
	 * @param event
	 */
	private CalendarNavigationButton(ImageResource baseImgRes, ImageResource disabledImgRes, ImageResource overImgRes, boolean enabled, String imgTitle, TeamingEvents eventEnum, VibeEventBase<?> event) {
		...
		addStyleName("vibe-calNavButton-widgetAnchor");
		m_enabled = (!enabled);
		setEnabled(enabled);
		...
		m_buttonImage.addStyleName("vibe-calNavButton-widgetImage");
	...
	public CalendarNavigationButton(ImageResource baseImgRes, ImageResource disabledImgRes, ImageResource overImgRes, boolean enabled, String imgTitle, TeamingEvents eventEnum) {
		this(baseImgRes, disabledImgRes, overImgRes, enabled, imgTitle, eventEnum, null);
	}
	
	public CalendarNavigationButton(ImageResource baseImgRes, ImageResource disabledImgRes, ImageResource overImgRes, boolean enabled, String imgTitle, VibeEventBase<?> event) {
	 ...
	 * @param event
	 */
	private CalendarNavigationButton(String buttonText, String buttonTitle, boolean enabled, TeamingEvents eventEnum, VibeEventBase<?> event) {
		// Initialize the super class...
		super();
		...
		m_buttonLabel.addStyleName("vibe-calNavButton-widgetText");
		if (!enabled) {
			m_buttonLabel.addStyleName("vibe-calNavButton-widgetTextDisabled");
		}
	...
	public CalendarNavigationButton(String buttonText, String buttonTitle, boolean enabled, TeamingEvents eventEnum) {
		this(buttonText, buttonTitle, enabled, eventEnum, null);
	}
	
	public CalendarNavigationButton(String buttonText, String buttonTitle, boolean enabled, VibeEventBase<?> event) {
	...
	public void setEnabled(boolean enabled, String imgTitle) {
		...
		if (null != m_buttonLabel) {
			m_buttonLabel.removeStyleName("vibe-calNavButton-widgetTextHover");
			if (enabled) m_buttonLabel.removeStyleName("vibe-calNavButton-widgetTextDisabled");
			else         m_buttonLabel.addStyleName(   "vibe-calNavButton-widgetTextDisabled");
		}
