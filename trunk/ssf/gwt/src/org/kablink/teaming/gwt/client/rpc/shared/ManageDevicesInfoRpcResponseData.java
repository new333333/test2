 ...
 * information about managing devices.
 * 
 * @author drfoster@novell.com
 */
public class ManageDevicesInfoRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 */
	public ManageDevicesInfoRpcResponseData() {
	 ...
	 */
	public ManageDevicesInfoRpcResponseData(BinderInfo profilesRootWSInfo) {
		// Initialize the super class...
		super();
