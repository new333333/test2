 ...
 */
public class CreateExternalUserReportCmd extends VibeRpcCmd{
	 ...
	 */
	public CreateExternalUserReportCmd() {
	...
	public int getCmdType() {
		return VibeRpcCmdType.CREATE_EXTERNAL_USER_REPORT.ordinal();
	}
}
