...
/**
 * This class represents the configuration data for a row in a table
 * @author jwootton
 *
 */
public class TableRowConfig extends ConfigItem
{
	private ArrayList<ConfigItem> m_configItems;	// Items that go in this row.
	
	
	/**
	 * 
	 */
	public TableRowConfig( String configStr )
	{
