...
create table SS_Functions (id number(19,0) not null, lockVersion number(19,0) not null, zoneId number(19,0) not null, name varchar2(128 char) not null, internalId varchar2(32 char), zoneWide number(1,0), primary key (id), unique (zoneId, name));
...
create table JBPM_LOG (ID_ number(19,0) not null, CLASS_ char(1 char) not null, INDEX_ number(10,0), DATE_ timestamp, TOKEN_ number(19,0), PARENT_ number(19,0), SWIMLANEINSTANCE_ number(19,0), TASKINSTANCE_ number(19,0), MESSAGE_ varchar2(4000 char), TASKOLDACTORID_ varchar2(255 char), TASKACTORID_ varchar2(255 char), NODE_ number(19,0), ENTER_ timestamp, LEAVE_ timestamp, DURATION_ number(19,0), TRANSITION_ number(19,0), SOURCENODE_ number(19,0), DESTINATIONNODE_ number(19,0), CHILD_ number(19,0), VARIABLEINSTANCE_ number(19,0), OLDSTRINGVALUE_ varchar2(4000 char), NEWSTRINGVALUE_ varchar2(4000 char), OLDDATEVALUE_ timestamp, NEWDATEVALUE_ timestamp, OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDLONGVALUE_ number(19,0), NEWLONGVALUE_ number(19,0), OLDLONGIDCLASS_ varchar2(255 char), OLDLONGIDVALUE_ number(19,0), NEWLONGIDCLASS_ varchar2(255 char), NEWLONGIDVALUE_ number(19,0), OLDBYTEARRAY_ number(19,0), NEWBYTEARRAY_ number(19,0), OLDSTRINGIDCLASS_ varchar2(255 char), OLDSTRINGIDVALUE_ varchar2(255 char), NEWSTRINGIDCLASS_ varchar2(255 char), NEWSTRINGIDVALUE_ varchar2(255 char), EXCEPTION_ varchar2(4000 char), ACTION_ number(19,0), primary key (ID_));
create table JBPM_MESSAGE (ID_ number(19,0) not null, CLASS_ char(1 char) not null, DESTINATION_ varchar2(255 char), EXCEPTION_ varchar2(4000 char), ISSUSPENDED_ number(1,0), TOKEN_ number(19,0), TEXT_ varchar2(255 char), NODE_ number(19,0), TRANSITIONNAME_ varchar2(255 char), ACTION_ number(19,0), TASKINSTANCE_ number(19,0), primary key (ID_));
...
CREATE TABLE SSQRTZ_fired_triggers  (    ENTRY_ID VARCHAR2(95) NOT NULL,    TRIGGER_NAME VARCHAR2(80) NOT NULL,    TRIGGER_GROUP VARCHAR2(80) NOT NULL,    IS_VOLATILE VARCHAR2(1) NOT NULL,    INSTANCE_NAME VARCHAR2(80) NOT NULL,    FIRED_TIME NUMBER(13) NOT NULL,    PRIORITY NUMBER(13) NOT NULL,    STATE VARCHAR2(16) NOT NULL,    JOB_NAME VARCHAR2(80) NULL,    JOB_GROUP VARCHAR2(80) NULL,    IS_STATEFUL VARCHAR2(1) NULL,    REQUESTS_RECOVERY VARCHAR2(1) NULL,    PRIMARY KEY (ENTRY_ID));
CREATE TABLE SSQRTZ_scheduler_state  (    INSTANCE_NAME VARCHAR2(80) NOT NULL,    LAST_CHECKIN_TIME NUMBER(13) NOT NULL,    CHECKIN_INTERVAL NUMBER(13) NOT NULL,    PRIMARY KEY (INSTANCE_NAME));
