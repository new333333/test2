...
create table SS_Events (id char(32) not null, lockVersion bigint not null, zoneId bigint, folderEntry bigint, principal bigint, binder bigint, ownerType varchar(16), ownerId bigint, owningBinderKey varchar(255), owningBinderId bigint, name varchar(64), dtStart datetime, dtCalcStart datetime, dtEnd datetime, dtCalcEnd datetime, frequency integer, repeatInterval integer, until datetime, repeatCount integer, weekStart integer, timeZoneSensitive bit, days varchar(100), monthDay varchar(100), yearDay varchar(100), weekNo varchar(100), months varchar(100), minutes varchar(100), hours varchar(100), duration varchar(32) not null, creation_date datetime, creation_principal bigint, modification_date datetime, modification_principal bigint, timeZone varchar(80), calUid varchar(255), freeBusy varchar(32), primary key (id)) ENGINE=InnoDB;
...
create table SS_Functions (id bigint not null auto_increment, lockVersion bigint not null, zoneId bigint not null, name varchar(128) not null, internalId varchar(32), zoneWide bit, primary key (id), unique (zoneId, name)) ENGINE=InnoDB;
...
create table SS_Principals (id bigint not null auto_increment, type varchar(16) not null, lockVersion bigint not null, zoneId bigint, workspaceId bigint, internalId varchar(32), deleted bit, disabled bit, logVersion bigint, emailAddress varchar(24), name varchar(128), foreignName varchar(128), theme varchar(64), parentBinder bigint, description_text mediumtext, description_format integer, title varchar(255), normalTitle varchar(255), iconName varchar(64), definitionType integer, entryDef char(32), creation_date datetime, creation_principal bigint, modification_date datetime, modification_principal bigint, diskQuota bigint, displayStyle varchar(16), loginDate datetime, firstName varchar(64), lastName varchar(64), middleName varchar(64), organization varchar(256), phone varchar(128), zonName varchar(100), skypeId varchar(64), twitterId varchar(64), status varchar(256), statusDate datetime, miniBlogId bigint, maxGroupsQuota bigint, diskSpaceUsed bigint, password varchar(64), timeZone varchar(80), locale varchar(32), digestSeed bigint, postUrl varchar(256), timeout integer, trusted bit, maxIdleTime integer, sameAddrPolicy bit, primary key (id), unique (zoneId, foreignName), unique (zoneId, name)) ENGINE=InnoDB;
...
alter table SS_FolderEntries add constraint FKA6632C831CD53535 foreign key (entryDef) references SS_Definitions (id);
...
alter table SS_Principals add constraint FK769381641CD53535 foreign key (entryDef) references SS_Definitions (id);
...
create table JBPM_LOG (ID_ bigint not null auto_increment, CLASS_ char(1) not null, INDEX_ integer, DATE_ datetime, TOKEN_ bigint, PARENT_ bigint, SWIMLANEINSTANCE_ bigint, TASKINSTANCE_ bigint, TASKOLDACTORID_ varchar(255), TASKACTORID_ varchar(255), MESSAGE_ varchar(4000), NODE_ bigint, ENTER_ datetime, LEAVE_ datetime, DURATION_ bigint, CHILD_ bigint, VARIABLEINSTANCE_ bigint, NEWLONGVALUE_ bigint, OLDSTRINGVALUE_ varchar(4000), NEWSTRINGVALUE_ varchar(4000), OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDDATEVALUE_ datetime, NEWDATEVALUE_ datetime, OLDSTRINGIDCLASS_ varchar(255), OLDSTRINGIDVALUE_ varchar(255), NEWSTRINGIDCLASS_ varchar(255), NEWSTRINGIDVALUE_ varchar(255), OLDBYTEARRAY_ bigint, NEWBYTEARRAY_ bigint, OLDLONGIDCLASS_ varchar(255), OLDLONGIDVALUE_ bigint, NEWLONGIDCLASS_ varchar(255), NEWLONGIDVALUE_ bigint, OLDLONGVALUE_ bigint, TRANSITION_ bigint, SOURCENODE_ bigint, DESTINATIONNODE_ bigint, EXCEPTION_ varchar(4000), ACTION_ bigint, primary key (ID_)) ENGINE=InnoDB;
...
CREATE TABLE SSQRTZ_TRIGGERS (TRIGGER_NAME VARCHAR(80) NOT NULL,TRIGGER_GROUP VARCHAR(80) NOT NULL,JOB_NAME VARCHAR(80) NOT NULL,JOB_GROUP VARCHAR(80) NOT NULL,IS_VOLATILE VARCHAR(1) NOT NULL,DESCRIPTION VARCHAR(120) NULL,NEXT_FIRE_TIME BIGINT(13) NULL,PREV_FIRE_TIME BIGINT(13) NULL,PRIORITY INTEGER NULL,TRIGGER_STATE VARCHAR(16) NOT NULL,TRIGGER_TYPE VARCHAR(8) NOT NULL,START_TIME BIGINT(13) NOT NULL,END_TIME BIGINT(13) NULL,CALENDAR_NAME VARCHAR(80) NULL,MISFIRE_INSTR SMALLINT(2) NULL,JOB_DATA BLOB NULL,PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP),INDEX (JOB_NAME, JOB_GROUP))TYPE=InnoDB;
...
CREATE TABLE SSQRTZ_SCHEDULER_STATE (INSTANCE_NAME VARCHAR(80) NOT NULL,LAST_CHECKIN_TIME BIGINT(13) NOT NULL,CHECKIN_INTERVAL BIGINT(13) NOT NULL,PRIMARY KEY (INSTANCE_NAME))TYPE=InnoDB;
