...
go
use sitescape;
create table SS_Attachments (id char(32) not null, type char(1) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) null, folderEntry numeric(19,0) null, principal numeric(19,0) null, binder numeric(19,0) null, ownerType varchar(16) null, ownerId numeric(19,0) null, owningBinderKey varchar(255) null, owningBinderId numeric(19,0) null, name varchar(64) null, relevanceUUID varchar(256) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, fileName nvarchar(255) null, fileLength numeric(19,0) null, lastVersion int null, repositoryName varchar(128) null, filelock_id varchar(128) null, filelock_subject nvarchar(192) null, filelock_owner numeric(19,0) null, filelock_expirationDate datetime null, filelock_ownerInfo nvarchar(256) null, filelock_dirty tinyint null, versionNumber int null, versionName nvarchar(256) null, parentAttachment char(32) null, primary key (id));
create table SS_AuditTrail (id char(32) not null, type char(1) not null, zoneId numeric(19,0) null, startBy numeric(19,0) null, startDate datetime null, endBy numeric(19,0) null, endDate datetime null, entityId numeric(19,0) null, entityType varchar(16) null, owningBinderId numeric(19,0) null, owningBinderKey varchar(255) null, description nvarchar(512) null, transactionType varchar(16) null, fileId char(32) null, applicationId numeric(19,0) null, deletedFolderEntryFamily nvarchar(32) null, tokenId numeric(19,0) null, state nvarchar(64) null, threadName nvarchar(64) null, definitionId varchar(32) null, ended tinyint null, primary key (id));
...
create table SS_Definitions (id char(32) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) not null, name nvarchar(64) null, title nvarchar(128) null, type int null, internalId varchar(32) null, visibility int null, encoding image null, binderId numeric(19,0) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, primary key (id), unique (zoneId, name, binderId));
...
create table SS_Functions (id numeric(19,0) identity not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) not null, name nvarchar(128) not null, internalId varchar(32) null, zoneWide tinyint null, primary key (id), unique (zoneId, name));
...
create table SS_Principals (id numeric(19,0) identity not null, type varchar(16) not null, lockVersion numeric(19,0) not null, zoneId numeric(19,0) null, workspaceId numeric(19,0) null, internalId varchar(32) null, deleted tinyint null, disabled tinyint null, logVersion numeric(19,0) null, emailAddress varchar(24) null, name nvarchar(128) null, foreignName nvarchar(128) null, theme varchar(64) null, parentBinder numeric(19,0) null, description_text ntext null, description_format int null, title nvarchar(255) null, normalTitle nvarchar(255) null, iconName varchar(64) null, definitionType int null, entryDef char(32) null, creation_date datetime null, creation_principal numeric(19,0) null, modification_date datetime null, modification_principal numeric(19,0) null, diskQuota numeric(19,0) null, displayStyle varchar(16) null, loginDate datetime null, firstName nvarchar(64) null, lastName nvarchar(64) null, middleName nvarchar(64) null, organization nvarchar(256) null, phone varchar(128) null, zonName nvarchar(100) null, skypeId nvarchar(64) null, twitterId nvarchar(64) null, status nvarchar(256) null, statusDate datetime null, miniBlogId numeric(19,0) null, maxGroupsQuota numeric(19,0) null, diskSpaceUsed numeric(19,0) null, password varchar(64) null, timeZone varchar(80) null, locale varchar(32) null, digestSeed numeric(19,0) null, postUrl nvarchar(256) null, timeout int null, trusted tinyint null, maxIdleTime int null, sameAddrPolicy tinyint null, primary key (id), unique (zoneId, foreignName), unique (zoneId, name));
...
create table SS_SeenMap (principalId numeric(19,0) not null, zoneId numeric(19,0) null, seenMap image not null, lastPrune datetime null, primary key (principalId));
...
create table SS_Tags (id char(32) not null, zoneId numeric(19,0) null, entity_id numeric(19,0) null, entity_type int null, owner_id numeric(19,0) null, owner_type int null, name nvarchar(64) null, isPublic tinyint null, primary key (id));
...
alter table SS_FolderEntries add constraint FKA6632C831CD53535 foreign key (entryDef) references SS_Definitions;
...
alter table SS_Principals add constraint FK769381641CD53535 foreign key (entryDef) references SS_Definitions;
...
create table JBPM_LOG (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, INDEX_ int null, DATE_ datetime null, TOKEN_ numeric(19,0) null, PARENT_ numeric(19,0) null, SWIMLANEINSTANCE_ numeric(19,0) null, TASKINSTANCE_ numeric(19,0) null, TASKOLDACTORID_ varchar(255) null, TASKACTORID_ varchar(255) null, TRANSITION_ numeric(19,0) null, SOURCENODE_ numeric(19,0) null, DESTINATIONNODE_ numeric(19,0) null, VARIABLEINSTANCE_ numeric(19,0) null, OLDBYTEARRAY_ numeric(19,0) null, NEWBYTEARRAY_ numeric(19,0) null, OLDLONGVALUE_ numeric(19,0) null, NEWLONGVALUE_ numeric(19,0) null, OLDDATEVALUE_ datetime null, NEWDATEVALUE_ datetime null, OLDDOUBLEVALUE_ double precision null, NEWDOUBLEVALUE_ double precision null, EXCEPTION_ varchar(4000) null, ACTION_ numeric(19,0) null, OLDLONGIDCLASS_ varchar(255) null, OLDLONGIDVALUE_ numeric(19,0) null, NEWLONGIDCLASS_ varchar(255) null, NEWLONGIDVALUE_ numeric(19,0) null, NODE_ numeric(19,0) null, ENTER_ datetime null, LEAVE_ datetime null, DURATION_ numeric(19,0) null, MESSAGE_ varchar(4000) null, OLDSTRINGIDCLASS_ varchar(255) null, OLDSTRINGIDVALUE_ varchar(255) null, NEWSTRINGIDCLASS_ varchar(255) null, NEWSTRINGIDVALUE_ varchar(255) null, CHILD_ numeric(19,0) null, OLDSTRINGVALUE_ varchar(4000) null, NEWSTRINGVALUE_ varchar(4000) null, primary key (ID_));
create table JBPM_MESSAGE (ID_ numeric(19,0) identity not null, CLASS_ char(1) not null, DESTINATION_ varchar(255) null, EXCEPTION_ varchar(4000) null, ISSUSPENDED_ tinyint null, TOKEN_ numeric(19,0) null, TEXT_ nvarchar(255) null, TRANSITIONNAME_ nvarchar(255) null, TASKINSTANCE_ numeric(19,0) null, NODE_ numeric(19,0) null, ACTION_ numeric(19,0) null, primary key (ID_));
...
CREATE TABLE SSQRTZ_FIRED_TRIGGERS (  ENTRY_ID VARCHAR (95)  NOT NULL ,  TRIGGER_NAME VARCHAR (80)  NOT NULL ,  TRIGGER_GROUP VARCHAR (80)  NOT NULL ,  IS_VOLATILE VARCHAR (1)  NOT NULL ,  INSTANCE_NAME VARCHAR (80)  NOT NULL ,  FIRED_TIME BIGINT NOT NULL ,  PRIORITY INTEGER NOT NULL ,  STATE VARCHAR (16)  NOT NULL,  JOB_NAME VARCHAR (80)  NULL ,  JOB_GROUP VARCHAR (80)  NULL ,  IS_STATEFUL VARCHAR (1)  NULL ,  REQUESTS_RECOVERY VARCHAR (1)  NULL,  PRIMARY KEY (ENTRY_ID));
CREATE TABLE SSQRTZ_PAUSED_TRIGGER_GRPS (  TRIGGER_GROUP VARCHAR (80)  NOT NULL,  PRIMARY KEY (TRIGGER_GROUP));
CREATE TABLE SSQRTZ_SCHEDULER_STATE (  INSTANCE_NAME VARCHAR (80)  NOT NULL ,  LAST_CHECKIN_TIME BIGINT NOT NULL ,  CHECKIN_INTERVAL BIGINT NOT NULL ,PRIMARY KEY (INSTANCE_NAME));
...
CREATE TABLE SSQRTZ_TRIGGERS (  TRIGGER_NAME VARCHAR (80)  NOT NULL ,  TRIGGER_GROUP VARCHAR (80)  NOT NULL ,  JOB_NAME VARCHAR (80)  NOT NULL ,  JOB_GROUP VARCHAR (80)  NOT NULL ,  IS_VOLATILE VARCHAR (1)  NOT NULL ,  DESCRIPTION VARCHAR (120) NULL ,  NEXT_FIRE_TIME BIGINT NULL ,  PREV_FIRE_TIME BIGINT NULL ,  PRIORITY INTEGER NULL ,  TRIGGER_STATE VARCHAR (16)  NOT NULL ,  TRIGGER_TYPE VARCHAR (8)  NOT NULL ,  START_TIME BIGINT NOT NULL ,  END_TIME BIGINT NULL ,  CALENDAR_NAME VARCHAR (80)  NULL ,  MISFIRE_INSTR SMALLINT NULL,  JOB_DATA IMAGE NULL,  PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP));
