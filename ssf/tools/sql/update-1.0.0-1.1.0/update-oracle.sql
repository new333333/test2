...
create table SS_SearchNodeInfo (indexName varchar2(160 char) not null, nodeId varchar2(128 char) not null, accessMode varchar2(16 char), outOfSynch number(1,0), primary key (indexName, nodeId));
