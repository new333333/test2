...
*/
	...
	public static void fetchCalendarEntriesCreatedOrModifiedOrEventDatedBetweenTwoDates() throws Exception {
		...
		System.out.println(crit.toQuery().asXML());
		// The above search string should print like this.
		// <QUERY><AND><FIELD fieldname="_docType" exactphrase="TRUE"><TERMS>entry</TERMS></FIELD><OR><FIELD fieldname="_entryType" exactphrase="TRUE"><TERMS>entry</TERMS></FIELD><FIELD fieldname="_entryType" exactphrase="TRUE"><TERMS>reply</TERMS></FIELD></OR><AND><FIELD fieldname="_family" exactphrase="TRUE"><TERMS>calendar</TERMS></FIELD><FIELD fieldname="_entryType" exactphrase="TRUE"><TERMS>entry</TERMS></FIELD><OR><RANGE fieldname="_creationDate" inclusive="TRUE"><START>20101101000000</START><FINISH>20101231000000</FINISH></RANGE><RANGE fieldname="_modificationDate" inclusive="TRUE"><START>20101101000000</START><FINISH>20101231000000</FINISH></RANGE><RANGE fieldname="_eventDates" inclusive="TRUE"><START>20101101000000</START><FINISH>20101231000000</FINISH></RANGE></OR><OR><FIELD fieldname="_binderId" exactphrase="TRUE"><TERMS>43</TERMS></FIELD><FIELD fieldname="_binderId" exactphrase="TRUE"><TERMS>148</TERMS></FIELD></OR></AND></AND></QUERY>
