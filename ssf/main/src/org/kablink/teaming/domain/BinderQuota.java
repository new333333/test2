...
public class BinderQuota extends ZonedObject {

	private Long binderId; // This is primary key
	...
	public Long getDiskSpaceUsedCumulative() {
		return diskSpaceUsedCumulative;
	}

	public void setDiskSpaceUsedCumulative(Long diskSpaceUsedCumulative) {
