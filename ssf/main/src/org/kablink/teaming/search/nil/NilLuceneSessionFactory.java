...
public class NilLuceneSessionFactory implements LuceneSessionFactory {
	...
	public LuceneReadSession openReadSession() throws LuceneException {
		return new NilLuceneReadSession();
	}

	public LuceneWriteSession openWriteSession(String[] nodeNames)
			throws LuceneException {
		return new NilLuceneWriteSession();
	}
