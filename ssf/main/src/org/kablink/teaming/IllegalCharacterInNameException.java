...
public class IllegalCharacterInNameException extends UncheckedCodedException {
    ...
    public IllegalCharacterInNameException(String errorCode, Object[] errorArgs) {
        super(errorCode, errorArgs);
    }
    public IllegalCharacterInNameException(String errorCode, Object[] errorArgs, String message) {
        super(errorCode, errorArgs, message);
    }
    public IllegalCharacterInNameException(String errorCode, Object[] errorArgs, String message, Throwable cause) {
