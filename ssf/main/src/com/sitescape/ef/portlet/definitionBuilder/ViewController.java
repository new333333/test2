...
public class DefinitionBuilderController extends SAbstractController {
	...
	public ModelAndView handleRenderRequestInternal(RenderRequest request, 
		...
		Document definitionConfig = (Document)model.get(Constants.CONFIG_DEFINITION);
		...
		if (!Validator.isNull(selectedItem) ) {
			...
			Definition def = (Definition)model.get(Constants.DEFINITION);
			...
			List currentDefinitions = (List)model.get(Constants.PUBLIC_DEFINITIONS);
		...
		model.put("data", data);
		return new ModelAndView(Constants.VIEW_DEFINITION, model);
