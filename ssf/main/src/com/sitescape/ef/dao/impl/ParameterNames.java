 ...
 * For example, "forumName" and zoneId in the following query string:
 * from Binder forum where forum.name=:forumName and forum.zone.id=:zoneId
 * 
 * @author Jong Kim
 *
 */
public class ParameterNames {
    ...
    public static final String COMPANY_ID = "zoneId";
}
