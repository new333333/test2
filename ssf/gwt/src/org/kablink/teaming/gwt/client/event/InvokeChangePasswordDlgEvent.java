...
/**
 * The InvokeChangePasswordEvent is used to invoke the "change password" dialog
 * 
 * @author jwootton@novell.com
 */
public class InvokeChangePasswordDlgEvent extends VibeEventBase<InvokeChangePasswordDlgEvent.Handler>
{
	...
	{
		void onInvokeChangePasswordDlgEvent( InvokeChangePasswordDlgEvent event );
	}
	...
	{
		handler.onInvokeChangePasswordDlgEvent( this );
	}
	...
	{
		GwtTeaming.fireEvent( new MenuHideEvent() );
	}
	...
	{
		return TeamingEvents.INVOKE_CHANGE_PASSWORD_DLG;
	}
