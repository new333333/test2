 ...
 * 'save task graph state' command.
 * 
 * @author drfoster@novell.com
 */
public class SaveTaskGraphStateCmd extends VibeRpcCmd {
	...
	public int getCmdType() {
		return VibeRpcCmdType.SAVE_TASK_GRAPH_STATE.ordinal();
	}
}
