 ...
 */
public class InvokeIdeasPortalEvent extends VibeEventBase<InvokeIdeasPortalEvent.Handler> {
	...
	public static void fireOne() {
		GwtTeaming.fireEvent(new InvokeIdeasPortalEvent());
	}
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.INVOKE_IDEAS_PORTAL;
	}
