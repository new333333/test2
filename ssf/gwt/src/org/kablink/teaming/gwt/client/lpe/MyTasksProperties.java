...
/**
 * This class holds all of the properties needed to define a "My tasks" widget in a landing page.
 * @author jwootton
 *
 */
public class MyTasksProperties
	implements PropertiesObj
{
	...
	{
		if ( props instanceof MyTasksProperties )
		{
			MyTasksProperties folderProps;
			
			folderProps = (MyTasksProperties) props;
	 ...
	 * "my tasks" option in the enhanced view widget.
	 */
	@Override
