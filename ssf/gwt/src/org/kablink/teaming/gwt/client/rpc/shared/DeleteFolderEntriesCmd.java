 ...
 */
public class DeleteFolderEntriesCmd extends VibeRpcCmd {
	 ...
	 * @param entryIds
	 */
	public DeleteFolderEntriesCmd(Long binderId, List<Long> entryIds) {
		this();
	 ...
	 * @param entryId
	 */
	public DeleteFolderEntriesCmd(Long binderId, Long entryId) {
