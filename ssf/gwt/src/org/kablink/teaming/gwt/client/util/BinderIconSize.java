...
public enum BinderIconSize implements IsSerializable {
	...
	public final static int BINDER_HEIGHT_MEDIUM_INT	= (-1);	// (-1) -> No vertical   scaling.  The native height is used.
	public final static int BINDER_WIDTH_MEDIUM_INT		= (-1); // (-1) -> No horizontal scaling.  The native width  is used.
	
	public final static int BINDER_HEIGHT_LARGE_INT		= 30;
	public final static int BINDER_WIDTH_LARGE_INT		= 30;
