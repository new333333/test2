...
public class FolderColumnsRpcResponseData implements IsSerializable, VibeRpcResponseData {
	...
	private List<FolderColumnInfo>	m_folderColumnsList;
	 ...
	 */
	public FolderColumnsRpcResponseData(List<FolderColumnInfo> folderColumnsList, String folderSortBy, boolean folderSortDescend) {
		this();
	...
	public List<FolderColumnInfo> getFolderColumns()     {return m_folderColumnsList;}
	...
	public void setFolderColumns(    List<FolderColumnInfo> folderColumnsList) {m_folderColumnsList = folderColumnsList;}
