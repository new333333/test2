 ...
 * between the client (i.e., the TaskListing) and the server (i.e.,
 * GwtRpcServiceImpl.getTaskBundle().)
 * 
...
public class TaskBundle implements IsSerializable {
	 ...
	 * @return
	 */
	public List<TaskInfo> getTasks()       {return m_tasks;      }
	 ...
	 * @return
	 */
	public void setTasks(      List<TaskInfo> tasks)    {m_tasks      = tasks;       }
