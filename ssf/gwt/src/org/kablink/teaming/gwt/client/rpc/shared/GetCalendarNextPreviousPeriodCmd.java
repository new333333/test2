...
public class GetCalendarNextPreviousPeriodCmd extends VibeRpcCmd {
	 ...
	 */
	public GetCalendarNextPreviousPeriodCmd() {
		super();
	}
	 ...
	 * @param next
	 */
	public GetCalendarNextPreviousPeriodCmd(Long folderId, CalendarDisplayDataRpcResponseData calendarDisplayData, boolean next) {
