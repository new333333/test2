	...
	<div class="ss_mashup_folder_header_view">
	  ...
	  <c:if test="${ssConfigJspStyle == 'mobile'}">
		  <a href="<ssf:url adapter="true" portletName="ss_forum" 
							...
							actionUrl="false" />"
		  ><span><c:if test="${empty ssBinder.title}" >
		  (<ssf:nlt tag="entry.noTitle" />)</c:if>
		  <c:out value="${ssBinder.title}" escapeXml="true" /></span></a>
...
<c:set var="configEle" value="<%= configEle %>" />
	      ...
	      <div class="ss_mashup_folder_list_open">
			<div class="ss_mashup_folder_list_open_title">
	                   ...
	                   <ssf:titleLink action="view_permalink" entryId="${entryMap._docId}" 
				binderId="${entryMap._binderId}" entityType="folderEntry">
