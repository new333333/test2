...
<a target="ss_new" href="<html:rootPath/>docs/icecore_manager_guide.pdf"><ssf:nlt tag="help.viewBooks.content.listItem.adminGetStart"><ssf:param name="value" value="${ssProductName}"/></ssf:nlt></a>
</div>
