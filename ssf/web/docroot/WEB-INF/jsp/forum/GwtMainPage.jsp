			...
			<div id="termsBlock">
				<div id="termsContainer" class="gwt-CheckBox" style="display:none; float:left;">
					<div>
						...
						<label id="acceptTermsAnchor" style="position:absolute; margin-top:-22px; cursor:pointer; color:#135c8f">I accept terms and conditions</label>
					</div>
				</div>
				<button type="button" class="gwt-Button teamingButton" style="display: none;color:white;" id="loginRegisterBtn"></button>
			</div>
