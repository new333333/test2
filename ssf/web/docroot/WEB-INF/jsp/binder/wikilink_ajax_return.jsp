...
<title><ssf:nlt tag="wiki.link.popup.title"/></title>
	<script language="javascript" type="text/javascript" src="<html:tinyMcePath/>tiny_mce_popup.js?<%= org.kablink.teaming.util.ReleaseInfo.getContentVersion() %>"></script>
	<script language="javascript" type="text/javascript" src="<html:tinyMcePath/>plugins/ss_wikilink/jscripts/functions.js?<%= org.kablink.teaming.util.ReleaseInfo.getContentVersion() %>"></script>
	<base target="_self" />
</head>
