...
<script type="text/javascript">
	...
	var	g_appConfigStrings = new Array();
		...
		g_appConfigStrings["sidebar.appConfig.helpUrl"]						= "<ssf:escapeJavaScript><%= MiscUtil.fixupHelpUrl("http://www.novell.com/documentation/vibe_onprem31/vibeprem31_user/data/trouble_editoroverrides.html") %></ssf:escapeJavaScript>";
