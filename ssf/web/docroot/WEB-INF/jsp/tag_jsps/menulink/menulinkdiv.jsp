...
<ul id="ss_folderMenuShowFileLink_<%= linkMenuIdx %>"><li><a href="#" onClick="<%= linkMenuObj %>.showFile(); return false;">
	<ssf:nlt tag="linkMenu.showFile"/></a></li></ul>
<ul id="ss_folderMenuShowEntryLink_<%= linkMenuIdx %>"><li><a href="#" onClick="<%= linkMenuObj %>.showEntry(); return false;">
	<ssf:nlt tag="linkMenu.showEntry"/></a></li></ul>
<ul id="ss_folderMenuShowCurrentTab_<%= linkMenuIdx %>" ><li><a href="#" onClick="<%= linkMenuObj %>.currentTab(); return false;">
	<ssf:nlt tag="linkMenu.currentTab"/></a></li></ul>
<ul id="ss_folderMenuShowNewTab_<%= linkMenuIdx %>" ><li><a href="#" onClick="<%= linkMenuObj %>.newTab(); return false;">
	<ssf:nlt tag="linkMenu.newTab"/></a></li></ul>
<ul id="ss_folderMenuShowNewWindow_<%= linkMenuIdx %>"><li><a href="#" onClick="<%= linkMenuObj %>.<%= strNewWindowFunction %>; return false;">
