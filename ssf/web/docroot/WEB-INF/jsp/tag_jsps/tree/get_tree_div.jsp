...
%>
	<taconite-replace contextNodeID="ss_tree_div_status_message" parseInBrowser="true">
		<div id="ss_tree_div_status_message" style="visibility:hidden; display:none;">error</div>
	</taconite-replace>
<%
	} else {
%>
	<taconite-replace contextNodeID="ss_tree_div_status_message" parseInBrowser="true">
		<div id="ss_tree_div_status_message" style="visibility:hidden; display:none;">ok</div>
	</taconite-replace>
