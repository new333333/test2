...
%>
<c:set var="align" value="left"/>
<c:if test="${!empty propertyValues_align3[0]}"><c:set var="align" value="${propertyValues_align3[0]}"/></c:if>
<c:set var="valign" value="top"/>
<c:if test="${!empty propertyValues_valign3[0]}"><c:set var="valign" value="${propertyValues_valign3[0]}"/></c:if>
<td align="${align}" valign="${valign}" <c:if test="${!empty property_width3}"> width="${property_width3}" </c:if> >
<ssf:displayConfiguration 
  configDefinition="${ssConfigDefinition}" 
...
<c:set var="valign" value="top"/>
<c:if test="${!empty propertyValues_valign3[0]}"><c:set var="valign" value="${propertyValues_valign3[0]}"/></c:if>
<td align="${align}" valign="${valign}" <c:if test="${!empty property_width3}"> width="${property_width3}" </c:if> >&nbsp;</td>
<%
				}
%>
</tr>
