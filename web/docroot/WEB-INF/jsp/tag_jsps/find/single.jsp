...
<c:if test="${empty ss_find_single_js_loaded}" >
  <script type="text/javascript" src="<html:rootPath/>js/jsp/tag_jsps/find/single.js"></script>
  <c:set var="ss_find_single_js_loaded" value="1" scope="request"/>
</c:if>
...
<div style="margin:0px; padding:0px;">
	...
	<textarea 
	    ...
	    onkeyup="ss_findUserSearch('${prefix}', this.id, '${ssFindFormElement}${ssFindInstanceCount}', '${ssFindListType}');"
