...
function ${wsTreeName}_showId(forum, obj, action) {
	...
	if (cDocument) {
		var r = cDocument.getElementById("ss_tree_radio${wsTreeName}targetId" + forum);
		if (r) {
...
<span class="ss_bold"><ssf:nlt tag="definition.moveDefinition"/> (<ssf:nlt tag="${ssBinder.title}" checkIfTag="true"/>)</span>
<br/>
<form class="ss_style ss_form" method="post" action="<ssf:url actionUrl="true" action="definition_builder"><ssf:param
			name="binderId" value="${ssBinder.id}"/><ssf:param
			name="operation" value="moveDefinition"/><ssf:param
