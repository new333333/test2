...
--%></c:if><%--
--%>${pageContext.request.contextPath}/<%= org.kablink.teaming.ObjectKeys.STATIC_DIR %>/<%= org.kablink.teaming.util.SPropsUtil.getString("release.static.dir", "xxx") %>/i/${ss_color_theme}/${ss_brand_prefix}/