...
/**
 * This servlet implements the application that the user interacts with.
 *
 */
public class CoAppServlet extends HttpServlet {

	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
	throws ServletException, IOException {
		HttpSession session = req.getSession(false);
		if(session != null) {
			String username = (String) session.getAttribute("teaming.coapp.sso.username");
			if(username != null)
