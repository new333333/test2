 ...
 * 'save share execution value' command.
 * 
 * @author drfoster@novell.com
 */
public class SaveShareExpirationValueCmd extends VibeRpcCmd {
	 ...
	 */
	private SaveShareExpirationValueCmd() {
	 ...
	 */
	public SaveShareExpirationValueCmd(Long shareId, ShareExpirationValue expirationValue) {
	...
	public int getCmdType() {
		return VibeRpcCmdType.SAVE_SHARE_EXPIRATION_VALUE.ordinal();
	}
}
