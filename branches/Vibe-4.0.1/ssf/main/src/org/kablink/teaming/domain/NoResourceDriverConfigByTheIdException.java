...
public class NoResourceDriverConfigByTheIdException extends NoObjectByTheIdException {
    ...
    public NoResourceDriverConfigByTheIdException(Long folderId, String message) {
        super(NoFolderByTheIdException_ErrorCode, folderId, message);
    }
    public NoResourceDriverConfigByTheIdException(Long folderId, String message, Throwable cause) {
        super(NoFolderByTheIdException_ErrorCode,folderId, message, cause);
    }
    public NoResourceDriverConfigByTheIdException(Long folderId, Throwable cause) {
