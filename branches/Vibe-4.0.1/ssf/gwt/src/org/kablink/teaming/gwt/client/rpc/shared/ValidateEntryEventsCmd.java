 ...
 * 'validate entry events' command.
 * 
 * @author drfoster@novell.com
 */
public class ValidateEntryEventsCmd extends VibeRpcCmd {
	 ...
	 */
	public ValidateEntryEventsCmd(String entryId, List<EventValidation> eventValidations) {
		this();		
		m_entryId          = entryId;
