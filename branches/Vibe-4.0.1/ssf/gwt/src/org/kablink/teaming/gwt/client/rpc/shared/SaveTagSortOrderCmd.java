...
/**
 * This class holds all of the information necessary to execute the "save tag sort order" command.
 * 
 * @author jwootton
 *
 */
public class SaveTagSortOrderCmd extends VibeRpcCmd
{
	 ...
	 * 
	 */
	public TagSortOrder getSortOrder()
	{
		return m_sortOrder;
	}
