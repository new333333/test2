...
<a href="javascript: ss_helpSystem.showHelpPanel('navigation_bar/favorites_button', 'ss_help_panel', '', '');">&lt;&lt;&lt; <ssf:nlt tag="helpPanel.button.previous"/></a>
</div>

<div class="ss_style" style="display:inline;margin-left:6px;">
<a href="javascript: ss_helpSystem.showHelpPanel('navigation_bar/favorites_button_categories', 'ss_help_panel', '', '');"><ssf:nlt tag="helpPanel.button.next"/> &gt;&gt;&gt;</a>
</div>
</div>
