...
<div class="ss_ClipboardUsersPane">
	<span onclick="if (window.ss_loadClipboardUsersList) ss_loadClipboardUsersList('${prefix}');"
		...
		<img <ssf:alt tag="alt.expand"/> id="ss_clipboardUsersIcon_${prefix}" src="<html:imagesPath/>pics/sym_s_expand.gif" />
	...
	<img <ssf:alt/> src="<html:imagesPath/>pics/1pix.gif" onload="ss_setClipboardUsersVariables('${prefix}', '${formElement}');" />
