...
function Slider(oElement, oInput, sOrientation) {
	if (!oElement) return;
	this._orientation = sOrientation || "slider-horizontal";
...
Slider.eventHandlers = {
	...
	onmousemove:	function (e) {
		...
		if (Slider._sliderDragData) {	// drag
			...
			if (s._orientation == "slider-horizontal") {
	...
	onkeydown:	function (e) {
		...
		switch (kc) {
			...
			case 34:	// page down
				...
				break;
			case 35:	// end
				s.setValue(s.getOrientation() == "slider-horizontal" ?
					s.getMaximum() :
					s.getMinimum());
				break;
			case 36:	// home
