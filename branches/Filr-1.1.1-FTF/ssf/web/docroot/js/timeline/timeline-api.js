    ...
    try {
        ...
        (function() {
            if (typeof Timeline_urlPrefix == "string") {
				...
				var where = [document.documentElement.getElementsByTagName("head"),document.documentElement.getElementsByTagName("body")];
				for(var w = 0; w < where.length; w++) {
					var tagcontents = where[w];
					for (var t = 0; t < tagcontents.length; t++) {
						var scripts = tagcontents[t].getElementsByTagName("script");
