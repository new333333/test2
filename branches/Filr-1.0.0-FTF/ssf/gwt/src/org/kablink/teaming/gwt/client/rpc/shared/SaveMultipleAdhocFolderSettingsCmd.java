 ...
 * 'save multiple adHoc folder settings' command.
 * 
...
public class SaveMultipleAdhocFolderSettingsCmd extends VibeRpcCmd {
	 ...
	 */
	public SaveMultipleAdhocFolderSettingsCmd() {
	...
	public int getCmdType() {
		return VibeRpcCmdType.SAVE_MULTIPLE_ADHOC_FOLDER_SETTINGS.ordinal();
	}
}
