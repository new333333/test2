...
/**
 * This class holds all of the information necessary to execute the "has the activity stream changed" command.
 * 
 * @author jwootton
 *
 */
public class HasActivityStreamChangedCmd extends VibeRpcCmd
{
