...
/**
 * The TaskSetPercentDoneEvent used to set a task to a specific percent
 * done value.
 * 
...
public class TaskSetPercentDoneEvent extends VibeEventBase<TaskSetPercentDoneEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onTaskSetPercentDone(TaskSetPercentDoneEvent event);
	}
	
	/**
	 * Class constructor.
	 */
	public TaskSetPercentDoneEvent(String eventOption) {
		super();
