...
create table JBPM_LOG (ID_ bigint not null auto_increment, CLASS_ char(1) not null, INDEX_ integer, DATE_ datetime, TOKEN_ bigint, PARENT_ bigint, SWIMLANEINSTANCE_ bigint, TASKINSTANCE_ bigint, TRANSITION_ bigint, CHILD_ bigint, VARIABLEINSTANCE_ bigint, OLDSTRINGVALUE_ varchar(4000), NEWSTRINGVALUE_ varchar(4000), OLDDATEVALUE_ datetime, NEWDATEVALUE_ datetime, OLDLONGVALUE_ bigint, NEWLONGVALUE_ bigint, OLDBYTEARRAY_ bigint, NEWBYTEARRAY_ bigint, OLDLONGIDCLASS_ varchar(255), OLDLONGIDVALUE_ bigint, NEWLONGIDCLASS_ varchar(255), NEWLONGIDVALUE_ bigint, OLDSTRINGIDCLASS_ varchar(255), OLDSTRINGIDVALUE_ varchar(255), NEWSTRINGIDCLASS_ varchar(255), NEWSTRINGIDVALUE_ varchar(255), TASKOLDACTORID_ varchar(255), TASKACTORID_ varchar(255), SOURCENODE_ bigint, DESTINATIONNODE_ bigint, EXCEPTION_ varchar(4000), ACTION_ bigint, MESSAGE_ varchar(4000), OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, NODE_ bigint, ENTER_ datetime, LEAVE_ datetime, DURATION_ bigint, primary key (ID_)) ENGINE=InnoDB;
