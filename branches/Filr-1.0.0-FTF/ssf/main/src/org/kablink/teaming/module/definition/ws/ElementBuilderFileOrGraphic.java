...
public class ElementBuilderFileOrGraphic extends AbstractElementBuilder {
	protected boolean build(Element element, org.kablink.teaming.remoting.ws.model.DefinableEntity entityModel, DefinableEntity entity, String dataElemType, String dataElemName, CustomAttribute attribute) {
		...
		for (FileAttachment att:files) {
			if (att != null && att.getFileItem() != null) {
				...
				if(values != null) {
					values.add(att.getFileItem().getName());
				}
			}
		}
		if(values != null)
