 ...
 *
 */
public interface LogTablePurge {

	public static final String LOG_TABLE_PURGE_GROUP="log-table-purge";
	public static final String LOG_TABLE_PURGE_DESCRIPTION="Purge log tables";
