		...
		<c:if test="${!empty ssEntries}">
	      <ul>
		    <c:forEach var="entry" items="${ssEntries}">
		      ...
		      <li id="<c:out value="ss_findEntries_id_${entry._docId}"/>"><a 
		          href="javascript:;" onClick="ss_findEntriesSelectItem${ss_namespace}(this.parentNode);" 
          ...
          <c:if test="${ss_searchTotalHits > ss_pageSize}">
            ...
            <c:if test="${ss_pageNumber > 0}">
              <a href="javascript:;" onClick="ss_findEntriesPrevPage${ss_namespace}();return false;"
            ...
            <c:if test="${count + ss_pageNumber * ss_pageSize < ss_searchTotalHits}">
              <a href="javascript:;" onClick="ss_findEntriesNextPage${ss_namespace}();return false;"
