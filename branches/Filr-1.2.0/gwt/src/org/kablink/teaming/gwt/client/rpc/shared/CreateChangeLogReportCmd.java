 ...
 * 'create change log report' command.
 * 
 * @author drfoster@novell.com
 */
public class CreateChangeLogReportCmd extends VibeRpcCmd {
	 ...
	 */
	private CreateChangeLogReportCmd() {
	 ...
	 * @param operation
	 */
	public CreateChangeLogReportCmd(Long binderId, Long entityId, String entityType, String operation) {
	...
	public void setOperation( String operation)  {m_operation  = operation; }
	...
	public int getCmdType() {
		return VibeRpcCmdType.CREATE_CHANGE_LOG_REPORT.ordinal();
	}
}
