 ...
 */
public class TrashPurgeSelectedEntitiesCmd extends VibeRpcCmd {
	 ...
	 */
	public TrashPurgeSelectedEntitiesCmd() {
		super();
	}
	 ...
	 * @param binderId
	 */
	public TrashPurgeSelectedEntitiesCmd(Long binderId, boolean purgeMirroredSources, List<String> trashSelectionData) {
		this();
	...
	public int getCmdType() {
		return VibeRpcCmdType.TRASH_PURGE_SELECTED_ENTITIES.ordinal();
	}
}
