...
/**
 * Class used to track an individual filter for the
 * FolderFilterRpcResponseData class and the SaveFolderFiltersCmd.
 * 
...
public class FolderFilter implements IsSerializable {
	 ...
	 * @param data
	 */
	public FolderFilter(String name, String data) {
