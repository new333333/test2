...
public class GetFolderEntryDetailsCmd extends VibeRpcCmd {
	 ...
	 * @param markRead
	 */
	public GetFolderEntryDetailsCmd(EntityId entityId, boolean markRead) {
	 ...
	 * @return
	 */
	public boolean  isMarkRead()  {return m_markRead;}
	 ...
	 * @param
	 */
	public void setMarkRead(boolean  markRead) {m_markRead = markRead;}
