...
/**
 * This class holds all of the information necessary to execute the "Persist Activity Stream Selection" command.
 * 
 * @author jwootton
 *
 */
public class PersistActivityStreamSelectionCmd extends VibeRpcCmd
{
