...
/**
 * This class holds all of the information necessary to execute the "execute enhanced view jsp" command.
 * 
 * @author jwootton
 *
 */
public class ExecuteEnhancedViewJspCmd extends VibeRpcCmd
{
	 ...
	 */
	public ExecuteEnhancedViewJspCmd()
	{
		super();
	}
