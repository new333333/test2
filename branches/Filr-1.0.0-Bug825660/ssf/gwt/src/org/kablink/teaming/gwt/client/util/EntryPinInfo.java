...
/**
 * Class used to bundle information regarding an entry's pin state
 * through GWT RPC requests.
 *  
 * @author drfoster
 */
public class EntryPinInfo implements IsSerializable {
	 ...
	 * @param entryId
	 */
	public EntryPinInfo(boolean pinned, Long folderId, Long entryId) {
		this();
