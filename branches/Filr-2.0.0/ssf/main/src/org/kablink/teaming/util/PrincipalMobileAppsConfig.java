 ...
 */
public class PrincipalMobileAppsConfig {
    ...
    private MobileOpenInSetting	m_mobileOpenIn;								//
	 ...
	 * Constructor method.
	 */
	public PrincipalMobileAppsConfig() {
		super();
	}
    ...
    public MobileOpenInSetting getMobileOpenIn()                             {return m_mobileOpenIn;                            }
    ...
    public void setMobileOpenIn(                            MobileOpenInSetting mobileOpenIn)                             {m_mobileOpenIn                             = mobileOpenIn;                            }
