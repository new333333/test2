...
create table JBPM_LOG (ID_ number(19,0) not null, CLASS_ char(1 char) not null, INDEX_ number(10,0), DATE_ timestamp, TOKEN_ number(19,0), PARENT_ number(19,0), SWIMLANEINSTANCE_ number(19,0), TASKINSTANCE_ number(19,0), TASKOLDACTORID_ varchar2(255 char), TASKACTORID_ varchar2(255 char), NODE_ number(19,0), ENTER_ timestamp, LEAVE_ timestamp, DURATION_ number(19,0), EXCEPTION_ varchar2(4000 char), ACTION_ number(19,0), VARIABLEINSTANCE_ number(19,0), NEWLONGVALUE_ number(19,0), MESSAGE_ varchar2(4000 char), CHILD_ number(19,0), TRANSITION_ number(19,0), SOURCENODE_ number(19,0), DESTINATIONNODE_ number(19,0), OLDBYTEARRAY_ number(19,0), NEWBYTEARRAY_ number(19,0), OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDLONGIDCLASS_ varchar2(255 char), OLDLONGIDVALUE_ number(19,0), NEWLONGIDCLASS_ varchar2(255 char), NEWLONGIDVALUE_ number(19,0), OLDSTRINGIDCLASS_ varchar2(255 char), OLDSTRINGIDVALUE_ varchar2(255 char), NEWSTRINGIDCLASS_ varchar2(255 char), NEWSTRINGIDVALUE_ varchar2(255 char), OLDLONGVALUE_ number(19,0), OLDDATEVALUE_ timestamp, NEWDATEVALUE_ timestamp, OLDSTRINGVALUE_ varchar2(4000 char), NEWSTRINGVALUE_ varchar2(4000 char), primary key (ID_));
