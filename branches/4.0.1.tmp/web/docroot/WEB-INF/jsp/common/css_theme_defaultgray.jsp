...
--%><%--
  ...
  -- BLOG
  --
--%><c:set var="ss_blog_summary_title_background_color" value="#AFAFAF" scope="request"/><%--
--%><c:set var="ss_blog_content_background_color" value="inherit" scope="request"/><%--
--%><c:set var="ss_blog_sidebar_box_outline" value="#AFAFAF" scope="request"/><%--
--%><c:set var="ss_blog_footer_color" value="#EEEEEE" scope="request"/><%--	
--%><%--
  --
  -- BORDER COLORS
  --
...
--%><c:set var="ss_style_border_color_dark_hue" value="#AFAFAF" scope="request"/><%--
--%><%--
  --
  -- BOX
  --
--%><c:set var="ss_box_title_color" value="#666666" scope="request"/><%--
...
--%><c:set var="ss_linkbutton_outline_color" value="#AFAFAF" scope="request"/><%--
...
--%><%--
  ...
  -- GUESTBOOK
  --
--%><c:set var="ss_guestbook_rule_color" value="#AFAFAF" scope="request"/><%--
--%><%--
  --
  -- HELP COLORS
  --
--%><c:set var="ss_help_spot_background_color" value="#EEEEEE" scope="request"/><%--
...
--%><%--
  ...
  -- HEADER COLORS
  --
--%><c:set var="ss_style_header_bar_background" value="#DDE5EF" scope="request"/><%--
...
--%><c:set var="ss_sliding_table_link_hover_color" value="#AFAFAF" scope="request"/><%--
...
--%><c:set var="ss_toolbar4_background_color" value="#DDDDDD" scope="request"/><%--
