...
public class TeamWorkspacesView extends DataTableFolderViewBase {
	 ...
	 */
	private TeamWorkspacesView(BinderInfo folderInfo, ViewReady viewReady) {
		// Simply initialize the base class.
		super(folderInfo, viewReady, "vibe-teamWorkspacesDataTable");
	}
	...
	public static void createAsync(final BinderInfo folderInfo, final ViewReady viewReady, final ViewClient vClient) {
		GWT.runAsync(TeamWorkspacesView.class, new RunAsyncCallback() {			
			...
			public void onSuccess() {
				TeamWorkspacesView dfView = new TeamWorkspacesView(folderInfo, viewReady);
