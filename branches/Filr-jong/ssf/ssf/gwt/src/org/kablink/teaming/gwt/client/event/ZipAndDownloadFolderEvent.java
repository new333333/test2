...
/**
 * The ZipAndDownloadFolderEvent is used to zip and download the
 * files in a folder.
 * 
...
public class ZipAndDownloadFolderEvent extends VibeEventBase<ZipAndDownloadFolderEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onZipAndDownloadFolder(ZipAndDownloadFolderEvent event);
	}
	 ...
	 * requirements.
	 */
	public ZipAndDownloadFolderEvent() {
	 ...
	 * @param recursive
	 */
	public ZipAndDownloadFolderEvent(Long folderId, Long handleByFolderId, boolean recursive) {
	 ...
	 * @param recursive
	 */
	public ZipAndDownloadFolderEvent(Long folderId, boolean recursive) {
		// Initialize this object.
		this(folderId, null, recursive);
	}
    ...
    protected void doDispatch(Handler handler) {
   		handler.onZipAndDownloadFolder(this);
    }    
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.ZIP_AND_DOWNLOAD_FOLDER;
	}
