...
/**
 * This class holds all of the information necessary to execute the "get share info" command.
 * 
 * @author jwootton
 *
 */
public class GetSharingInfoCmd extends VibeRpcCmd
{
	...
	{
		return VibeRpcCmdType.GET_SHARING_INFO.ordinal();
	}
