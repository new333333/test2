 ...
 * 'dump history info' command.
 * 
 * @author drfoster@novell.com
 */
public class DumpHistoryInfoCmd extends VibeRpcCmd {
	 ...
	 * @param historyInfo
	 */
	public DumpHistoryInfoCmd(String method, String historyToken, HistoryInfo historyInfo) {
	...
	public void setMethod(      String      method)       {m_method       = method;      }
	...
	public int getCmdType() {
		return VibeRpcCmdType.DUMP_HISTORY_INFO.ordinal();
	}
}
