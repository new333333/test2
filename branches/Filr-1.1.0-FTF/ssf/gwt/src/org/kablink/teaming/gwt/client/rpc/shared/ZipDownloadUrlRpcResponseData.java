...
/**
 * This class holds the response data for the 'get zip download url'
 * command.
 * 
 * @author drfoster@novell.com
 */
public class ZipDownloadUrlRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 * requirements.
	 */
	public ZipDownloadUrlRpcResponseData() {
	 ...
	 * @param url
	 */
	public ZipDownloadUrlRpcResponseData(String url) {
