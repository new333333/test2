...
public class GwtViewHelper {
	...
	// default, it is not (the value defaults to false.)
	private final static boolean SHOW_LAST_LOGIN_IN_USER_PROPERTIES	= SPropsUtil.getBoolean("show.last.login.in.user.properties", false);
