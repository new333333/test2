...
create table SS_Definitions (id char(32) not null, lockVersion number(19,0) not null, zoneId number(19,0) not null, name varchar2(64 char), title varchar2(128 char), internalId varchar2(32 char), type number(10,0), visibility number(10,0), encoding blob, binderId number(19,0), creation_date timestamp, creation_principal number(19,0), modification_date timestamp, modification_principal number(19,0), primary key (id), unique (zoneId, binderId, name));
...
create table SS_EmailLog (id char(32) not null, zoneId number(19,0) not null, sendDate timestamp not null, fromField varchar2(255 char), subj varchar2(255 char), comments clob, status varchar2(16 char) not null, type varchar2(32 char) not null, toEmailAddresses clob, fileAttachments clob, primary key (id));
create table SS_Events (id char(32) not null, lockVersion number(19,0) not null, zoneId number(19,0), folderEntry number(19,0), principal number(19,0), binder number(19,0), ownerType varchar2(16 char), ownerId number(19,0), owningBinderKey varchar2(255 char), owningBinderId number(19,0), name varchar2(64 char), dtStart timestamp, dtCalcStart timestamp, dtEnd timestamp, dtCalcEnd timestamp, frequency number(10,0), repeatInterval number(10,0), until timestamp, repeatCount number(10,0), weekStart number(10,0), timeZoneSensitive number(1,0), days varchar2(100 char), monthDay varchar2(100 char), yearDay varchar2(100 char), weekNo varchar2(100 char), months varchar2(100 char), minutes varchar2(100 char), hours varchar2(100 char), duration varchar2(32 char), creation_date timestamp, creation_principal number(19,0), modification_date timestamp, modification_principal number(19,0), timeZone varchar2(80 char), calUid varchar2(255 char), freeBusy varchar2(32 char), primary key (id));
...
create table SS_SeenMap (principalId number(19,0) not null, zoneId number(19,0), seenMap blob not null, lastPrune timestamp, pruneDays number(19,0), primary key (principalId));
create table SS_SharedEntity (id char(32) not null, referer number(19,0), zoneId number(19,0), accessType number(19,0), accessId number(19,0), sharedDate timestamp, entityType varchar2(16 char), entityId number(19,0), primary key (id));
...
create table SS_Tags (id char(32) not null, zoneId number(19,0), entity_type number(10,0), entity_id number(19,0), owner_type number(10,0), owner_id number(19,0), name varchar2(64 char), isPublic number(1,0), primary key (id));
create table SS_TokenInfo (id char(32) not null, type char(1 char) not null, zoneId number(19,0), seed varchar2(128 char), lastAccessTime timestamp, userId number(19,0), applicationId number(19,0), binderId number(19,0), binderAccessConstraints number(10,0), requesterId number(19,0), clientAddr varchar2(128 char), primary key (id));
...
create table SS_ZoneConfig (zoneId number(19,0) not null, upgradeVersion number(10,0), mobileAccessEnabled number(1,0), diskQuotasEnabled number(1,0), diskQuotaUserDefault number(10,0), diskQuotasHighwaterPercentage number(10,0), fileSizeLimitUserDefault number(19,0), binderQuotasInitialized number(1,0), binderQuotasEnabled number(1,0), binderQuotasAllowOwner number(1,0), fileVersionsMaxAge number(19,0), fsaEnabled number(1,0), fsaSynchInterval number(10,0), fsaAutoUpdateUrl varchar2(255 char), postingEnabled number(1,0), simpleUrlPostingEnabled number(1,0), sendMailEnabled number(1,0), defaultHomePageId number(19,0), defaultGuestHomePageId number(19,0), holidays varchar2(4000 char), weekendDays varchar2(128 char), allowLocalLogin number(1,0), allowAnonymousAccess number(1,0), allowSelfRegistration number(1,0), lastUpdate number(19,0), primary key (zoneId));
...
create table JBPM_LOG (ID_ number(19,0) not null, CLASS_ char(1 char) not null, INDEX_ number(10,0), DATE_ timestamp, TOKEN_ number(19,0), PARENT_ number(19,0), SWIMLANEINSTANCE_ number(19,0), TASKINSTANCE_ number(19,0), TRANSITION_ number(19,0), EXCEPTION_ varchar2(4000 char), ACTION_ number(19,0), SOURCENODE_ number(19,0), DESTINATIONNODE_ number(19,0), CHILD_ number(19,0), TASKOLDACTORID_ varchar2(255 char), TASKACTORID_ varchar2(255 char), MESSAGE_ varchar2(4000 char), NODE_ number(19,0), ENTER_ timestamp, LEAVE_ timestamp, DURATION_ number(19,0), NEWLONGVALUE_ number(19,0), VARIABLEINSTANCE_ number(19,0), OLDDATEVALUE_ timestamp, NEWDATEVALUE_ timestamp, OLDBYTEARRAY_ number(19,0), NEWBYTEARRAY_ number(19,0), OLDSTRINGIDCLASS_ varchar2(255 char), OLDSTRINGIDVALUE_ varchar2(255 char), NEWSTRINGIDCLASS_ varchar2(255 char), NEWSTRINGIDVALUE_ varchar2(255 char), OLDLONGVALUE_ number(19,0), OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDSTRINGVALUE_ varchar2(4000 char), NEWSTRINGVALUE_ varchar2(4000 char), OLDLONGIDCLASS_ varchar2(255 char), OLDLONGIDVALUE_ number(19,0), NEWLONGIDCLASS_ varchar2(255 char), NEWLONGIDVALUE_ number(19,0), primary key (ID_));
create table JBPM_MESSAGE (ID_ number(19,0) not null, CLASS_ char(1 char) not null, DESTINATION_ varchar2(255 char), EXCEPTION_ varchar2(4000 char), ISSUSPENDED_ number(1,0), TOKEN_ number(19,0), TEXT_ varchar2(255 char), TRANSITIONNAME_ varchar2(255 char), NODE_ number(19,0), TASKINSTANCE_ number(19,0), ACTION_ number(19,0), primary key (ID_));
...
CREATE TABLE SSQRTZ_job_details  (    JOB_NAME  VARCHAR2(100) NOT NULL,    JOB_GROUP VARCHAR2(100) NOT NULL,    DESCRIPTION VARCHAR2(250) NULL,    JOB_CLASS_NAME   VARCHAR2(250) NOT NULL,    IS_DURABLE VARCHAR2(1) NOT NULL,    IS_VOLATILE VARCHAR2(1) NOT NULL,    IS_STATEFUL VARCHAR2(1) NOT NULL,    REQUESTS_RECOVERY VARCHAR2(1) NOT NULL,    JOB_DATA BLOB NULL,    PRIMARY KEY (JOB_NAME,JOB_GROUP));
CREATE TABLE SSQRTZ_job_listeners  (    JOB_NAME  VARCHAR2(100) NOT NULL,    JOB_GROUP VARCHAR2(100) NOT NULL,    JOB_LISTENER VARCHAR2(100) NOT NULL,    PRIMARY KEY (JOB_NAME,JOB_GROUP,JOB_LISTENER),    FOREIGN KEY (JOB_NAME,JOB_GROUP)	REFERENCES SSQRTZ_JOB_DETAILS(JOB_NAME,JOB_GROUP));
CREATE TABLE SSQRTZ_triggers  (    TRIGGER_NAME VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    JOB_NAME  VARCHAR2(100) NOT NULL,    JOB_GROUP VARCHAR2(100) NOT NULL,    IS_VOLATILE VARCHAR2(1) NOT NULL,    DESCRIPTION VARCHAR2(250) NULL,    NEXT_FIRE_TIME NUMBER(13) NULL,    PREV_FIRE_TIME NUMBER(13) NULL,    PRIORITY NUMBER(13) NULL,    TRIGGER_STATE VARCHAR2(16) NOT NULL,    TRIGGER_TYPE VARCHAR2(8) NOT NULL,    START_TIME NUMBER(13) NOT NULL,    END_TIME NUMBER(13) NULL,    CALENDAR_NAME VARCHAR2(100) NULL,    MISFIRE_INSTR NUMBER(2) NULL,    JOB_DATA BLOB NULL,    PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP),    FOREIGN KEY (JOB_NAME,JOB_GROUP)	REFERENCES SSQRTZ_JOB_DETAILS(JOB_NAME,JOB_GROUP));
CREATE TABLE SSQRTZ_simple_triggers  (    TRIGGER_NAME VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    REPEAT_COUNT NUMBER(7) NOT NULL,    REPEAT_INTERVAL NUMBER(12) NOT NULL,    TIMES_TRIGGERED NUMBER(10) NOT NULL,    PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP),    FOREIGN KEY (TRIGGER_NAME,TRIGGER_GROUP)	REFERENCES SSQRTZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_cron_triggers  (    TRIGGER_NAME VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    CRON_EXPRESSION VARCHAR2(120) NOT NULL,    TIME_ZONE_ID VARCHAR2(80),    PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP),    FOREIGN KEY (TRIGGER_NAME,TRIGGER_GROUP)	REFERENCES SSQRTZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_blob_triggers  (    TRIGGER_NAME VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    BLOB_DATA BLOB NULL,    PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP),    FOREIGN KEY (TRIGGER_NAME,TRIGGER_GROUP)        REFERENCES SSQRTZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_trigger_listeners  (    TRIGGER_NAME  VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    TRIGGER_LISTENER VARCHAR2(100) NOT NULL,    PRIMARY KEY (TRIGGER_NAME,TRIGGER_GROUP,TRIGGER_LISTENER),    FOREIGN KEY (TRIGGER_NAME,TRIGGER_GROUP)	REFERENCES SSQRTZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP));
CREATE TABLE SSQRTZ_calendars  (    CALENDAR_NAME  VARCHAR2(100) NOT NULL,    CALENDAR BLOB NOT NULL,    PRIMARY KEY (CALENDAR_NAME));
CREATE TABLE SSQRTZ_paused_trigger_grps  (    TRIGGER_GROUP  VARCHAR2(100) NOT NULL,    PRIMARY KEY (TRIGGER_GROUP));
CREATE TABLE SSQRTZ_fired_triggers  (    ENTRY_ID VARCHAR2(95) NOT NULL,    TRIGGER_NAME VARCHAR2(100) NOT NULL,    TRIGGER_GROUP VARCHAR2(100) NOT NULL,    IS_VOLATILE VARCHAR2(1) NOT NULL,    INSTANCE_NAME VARCHAR2(100) NOT NULL,    FIRED_TIME NUMBER(13) NOT NULL,    PRIORITY NUMBER(13) NOT NULL,    STATE VARCHAR2(16) NOT NULL,    JOB_NAME VARCHAR2(100) NULL,    JOB_GROUP VARCHAR2(100) NULL,    IS_STATEFUL VARCHAR2(1) NULL,    REQUESTS_RECOVERY VARCHAR2(1) NULL,    PRIMARY KEY (ENTRY_ID));
CREATE TABLE SSQRTZ_scheduler_state  (    INSTANCE_NAME VARCHAR2(100) NOT NULL,    LAST_CHECKIN_TIME NUMBER(13) NOT NULL,    CHECKIN_INTERVAL NUMBER(13) NOT NULL,    PRIMARY KEY (INSTANCE_NAME));
