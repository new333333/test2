...
/**
 * This class holds the response data for the 'delete proxy identities'
 * RPC command.
 * 
 * @author drfoster@novell.com
 */
public class DeleteProxyIdentitiesRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 */
	public DeleteProxyIdentitiesRpcResponseData() {
	 ...
	 * @param errorList
	 */
	public DeleteProxyIdentitiesRpcResponseData(List<ErrorInfo> errorList) {
