...
dojo.provide("sitescape.widget.DropdownTimePickerSf");
dojo.require("dojo.widget.*");
dojo.require("dojo.widget.DropdownContainer");
dojo.require("sitescape.widget.TimePickerSf");
...
dojo.widget.defineWidget("sitescape.widget.DropdownTimePickerSf", dojo.widget.DropdownContainer, {iconURL:dojo.uri.dojoUri("src/widget/templates/images/timeIcon.gif"), formatLength:"short", displayFormat:"", timeFormat:"", saveFormat:"", value:"", name:"", postMixInProperties:function () {
	sitescape.widget.DropdownTimePickerSf.superclass.postMixInProperties.apply(this, arguments);
	...
	if (this.value && isNaN(this.value)) {
		...
		if (!this.value) {
			...
			dojo.deprecated("sitescape.widget.DropdownTimePickerSf", "time attributes must be passed in Rfc3339 format", "0.5");
		}
	}
	if (this.value && !isNaN(this.value)) {
	...
	sitescape.widget.DropdownTimePickerSf.superclass.fillInTemplate.apply(this, arguments);
	var value = "";
	...
	this.timePicker = dojo.widget.createWidget("TimePickerSf", tpArgs, this.containerNode, "child");
	...
	if (this.timePicker.selectedTime.anyTime) {
		...
		if (this.timeFormat) {
			dojo.deprecated("sitescape.widget.DropdownTimePickerSf", "Must use displayFormat attribute instead of timeFormat.  See dojo.date.format for specification.", "0.5");
	...
	if (this.dateFormat) {
		dojo.deprecated("sitescape.widget.DropdownTimePickerSf", "Cannot parse user input.  Must use displayFormat attribute instead of dateFormat.  See dojo.date.format for specification.", "0.5");
	} else {
	...
	sitescape.widget.DropdownTimePickerSf.superclass.destroy.apply(this, arguments);
}});
