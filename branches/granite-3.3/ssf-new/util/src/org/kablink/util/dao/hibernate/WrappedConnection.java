...
public class WrappedConnection implements Connection {
	...
	private Connection conn; // source connection
	private String owningThreadName;
	private Exception stackTrace;
	
	public WrappedConnection(Connection conn) {
		this.conn = conn;
		owningThreadName = Thread.currentThread().getName();
		stackTrace = new Exception(); // to capture stack trace
	}

	public void asString(StringBuilder sb) {
		sb.append("Owning thread name: " + owningThreadName).append("\n");
		sb.append("Where it was borrowed: ");
