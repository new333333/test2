...
create table JBPM_LOG (ID_ bigint not null auto_increment, CLASS_ char(1) not null, INDEX_ integer, DATE_ datetime, TOKEN_ bigint, PARENT_ bigint, SWIMLANEINSTANCE_ bigint, TASKINSTANCE_ bigint, NODE_ bigint, ENTER_ datetime, LEAVE_ datetime, DURATION_ bigint, TASKOLDACTORID_ varchar(255), TASKACTORID_ varchar(255), MESSAGE_ varchar(4000), TRANSITION_ bigint, EXCEPTION_ varchar(4000), ACTION_ bigint, SOURCENODE_ bigint, DESTINATIONNODE_ bigint, CHILD_ bigint, NEWLONGVALUE_ bigint, VARIABLEINSTANCE_ bigint, OLDDATEVALUE_ datetime, NEWDATEVALUE_ datetime, OLDLONGIDCLASS_ varchar(255), OLDLONGIDVALUE_ bigint, NEWLONGIDCLASS_ varchar(255), NEWLONGIDVALUE_ bigint, OLDSTRINGIDCLASS_ varchar(255), OLDSTRINGIDVALUE_ varchar(255), NEWSTRINGIDCLASS_ varchar(255), NEWSTRINGIDVALUE_ varchar(255), OLDSTRINGVALUE_ varchar(4000), NEWSTRINGVALUE_ varchar(4000), OLDLONGVALUE_ bigint, OLDDOUBLEVALUE_ double precision, NEWDOUBLEVALUE_ double precision, OLDBYTEARRAY_ bigint, NEWBYTEARRAY_ bigint, primary key (ID_)) ENGINE=InnoDB;
create table JBPM_MESSAGE (ID_ bigint not null auto_increment, CLASS_ char(1) not null, DESTINATION_ varchar(255), EXCEPTION_ varchar(4000), ISSUSPENDED_ bit, TOKEN_ bigint, TEXT_ varchar(255), NODE_ bigint, ACTION_ bigint, TRANSITIONNAME_ varchar(255), TASKINSTANCE_ bigint, primary key (ID_)) ENGINE=InnoDB;
