 ...
 *
 */
public interface FolderNotification  {
    
	public static final String NOTIFICATION_GROUP="folder-notifications";
	public static final String NOTIFICATION_DESCRIPTION="Send folder-notifications";
