...
public class PathTooLongException extends FIException {

	private static final long serialVersionUID = 1L;

	private static final String ERROR_CODE = "fi.error.path.too.long";
	 ...
	 */
	public PathTooLongException(String resourcePath, String operationName) {
	...
	public ApiErrorCode getApiErrorCode() {
		return ApiErrorCode.FILE_PATH_TOO_LONG;
	}
