...
/**
 * This class holds all of the properties needed to define a "Task Folder" widget in a landing page.
 * @author jwootton
 *
 */
public class TaskFolderProperties
	implements PropertiesObj
{
	private int m_numTasksToBeShown;
	 ...
	 * 
	 */
	public TaskFolderProperties()
	{
		m_numTasksToBeShown = 0;
		m_folderId = null;
		m_folderTitle = null;
		m_zoneUUID = null;
	...
	public void copy( PropertiesObj props )
	{
		...
		{
			TaskFolderProperties folderProps;
			String newFolderId;
			
			folderProps = (TaskFolderProperties) props;
	 ...
	 * 
	 */
	public Long getFolderIdL()
	{
		return Long.valueOf( m_folderId );
	}
	...
	/**
	 * Return the "number of tasks to be shown" property.
	 */
	public int getNumTasksToBeShownValue()
	{
		return m_numTasksToBeShown;
	}
	...
	/**
	 * Set the "number of tasks to be shown" property.
	 */
