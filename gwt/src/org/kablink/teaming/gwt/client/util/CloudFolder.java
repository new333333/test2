...
/**
 * Class used in GWT RPC calls to represent a Cloud Folder object.
 * 
 * @author drfoster@novell.com
 */
public class CloudFolder implements IsSerializable, VibeRpcResponseData {
	 ...
	 * @param name
	 */
	public CloudFolder(CloudFolderType cft, Long id, String name) {
