 ...
 */
public class BinderViewThreeColumnTable extends BinderViewContainer {
    private Width column1Width;
    private Width column2Width;
    private Width column3Width;

    public BinderViewThreeColumnTable() {
    }
    ...
    public Width getColumn3Width() {
        return column3Width;
    }

    public void setColumn3Width(Width column3Width) {
