 ...
 * 'Set Anti Virus Settings' command.
 * 
 * @author drfoster@novell.com
 */
public class SetAntiVirusSettingsCmd extends VibeRpcCmd {
	 ...
	 */
	private SetAntiVirusSettingsCmd() {
	 ...
	 * @param avConfig
	 */
	public SetAntiVirusSettingsCmd(GwtAntiVirusConfig avConfig) {
	...
	public int getCmdType() {
		return VibeRpcCmdType.SET_ANTIVIRUS_SETTINGS.ordinal();
	}
}
