 ...
 * 'purge users and their workspaces' command.
 * 
 * @author drfoster@novell.com
 */
public class PurgeUsersCmd extends DeletePurgeUsersCmdBase {
	 ...
	 * @param purgeMirrored
	 */
	public PurgeUsersCmd(final List<Long> userIds, final boolean purgeMirrored) {
		// Initialize the super class...
		super(userIds);
	...
	public int getCmdType() {
		return VibeRpcCmdType.PURGE_USERS.ordinal();
	}
}
