 ...
 */
public class HideSharesCmd extends VibeRpcCmd {
	 ...
	 * @param entityId
	 */
	public HideSharesCmd(CollectionType ct, EntityId entityId) {
	 ...
	 * @param entityIds
	 */
	public HideSharesCmd(CollectionType ct, List<EntityId> entityIds) {
		// Initialize this object...
		this();		
	...
	public int getCmdType() {
		return VibeRpcCmdType.HIDE_SHARES.ordinal();
	}
}
