 ...
 * 'set default user settings' command.
 * 
 * @author drfoster@novell.com
 */
public class SetDefaultUserSettingsCmd extends VibeRpcCmd {
	 ...
	 */
	private SetDefaultUserSettingsCmd() {
	 ...
	 * @param localeExt
	 */
	public SetDefaultUserSettingsCmd(String timeZone, String locale, String timeZoneExt, String localeExt) {
	...
	public int getCmdType() {
		return VibeRpcCmdType.SET_DEFAULT_USER_SETTINGS.ordinal();
	}
}
