 ...
 * 'Get Calendar Display Data' command.
 * 
 * @author drfoster@novell.com
 */
public class GetCalendarDisplayDataCmd extends VibeRpcCmd {
	 ...
	 */
	private GetCalendarDisplayDataCmd() {
		super();
	}
	 ...
	 * @param folderInfo
	 */
	public GetCalendarDisplayDataCmd(long browserTZOffset, BinderInfo folderInfo) {
	...
	public int getCmdType() {
		return VibeRpcCmdType.GET_CALENDAR_DISPLAY_DATA.ordinal();
	}
}
