 ...
 */
public class SetLimitedUserVisibilityRpcResponseData implements IsSerializable, VibeRpcResponseData {
	private ErrorListRpcResponseData				m_errorList;						//
	private Map<Long, LimitedUserVisibilityInfo>	m_limitedUserVisibilityChangeMap;	//
	 ...
	 */
	public SetLimitedUserVisibilityRpcResponseData() {
	 ...
	 * @param errorList
	 */
	public SetLimitedUserVisibilityRpcResponseData(List<ErrorInfo> errorList) {
	 ...
	 * @return
	 */
	public Map<Long, LimitedUserVisibilityInfo> getLimitedUserVisibilityChangeMap() {return m_limitedUserVisibilityChangeMap;}
	 ...
	 * @param
	 */
	public void setLimitedUserVisibilityChangeMap(Map<Long, LimitedUserVisibilityInfo> limitedUserVisibilityChangeMap) {m_limitedUserVisibilityChangeMap = limitedUserVisibilityChangeMap;}
