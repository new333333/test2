 ...
 * 'save subscription data' command.
 * 
 * @author drfoster@novell.com
 */
public class SaveSubscriptionDataCmd extends VibeRpcCmd {
	 ...
	 */
	public SaveSubscriptionDataCmd(String entryId, SubscriptionData subscriptionData) {
		this();		
		m_entryId          = entryId;
