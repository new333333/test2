 ...
 */
public class DeleteMobileDevicesRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 */
	public DeleteMobileDevicesRpcResponseData() {
	 ...
	 * @param errorList
	 */
	public DeleteMobileDevicesRpcResponseData(List<ErrorInfo> errorList) {
