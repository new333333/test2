 ...
 * the current anti virus settings.
 * 
 * @author drfoster@novell.com
 */
public class AntiVirusSettingsRpcResponseData implements IsSerializable, VibeRpcResponseData {
	 ...
	 */
	private AntiVirusSettingsRpcResponseData() {
	 ...
	 * @param avConfig
	 */
	public AntiVirusSettingsRpcResponseData(GwtAntiVirusConfig avConfig) {
