...
/**
 * This class holds the response data for the 'delete customized email
 * templates' RPC command.
 * 
 * @author drfoster@novell.com
 */
public class DeleteCustomizedEmailTemplatesRpcResponseData implements IsSerializable, VibeRpcResponseData {
	private ErrorListRpcResponseData	m_errorList;			//
	private List<EntityId>				m_successfulDeletes;	//
	 ...
	 */
	public DeleteCustomizedEmailTemplatesRpcResponseData() {
	 ...
	 * @param errorList
	 */
	public DeleteCustomizedEmailTemplatesRpcResponseData(List<ErrorInfo> errorList) {
	 ...
	 * @return
	 */
	public List<EntityId> getSuccessfulDeletes() {return m_successfulDeletes;}
	 ...
	 * @param
	 */
	public void setSuccessfulDeletes(List<EntityId> successfulDeletes) {m_successfulDeletes = successfulDeletes;}
