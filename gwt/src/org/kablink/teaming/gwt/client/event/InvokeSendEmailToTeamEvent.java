...
/**
 * The InvokeSendEmailToTeamEvent is used to invoke Vibe's send email
 * to team dialog.
 * 
...
public class InvokeSendEmailToTeamEvent extends VibeEventBase<InvokeSendEmailToTeamEvent.Handler> {
	...
	public interface Handler extends EventHandler {
		void onInvokeSendEmailToTeam(InvokeSendEmailToTeamEvent event);
	}
	...
	public TeamingEvents getEventEnum() {
		return TeamingEvents.INVOKE_SEND_EMAIL_TO_TEAM;
	}
