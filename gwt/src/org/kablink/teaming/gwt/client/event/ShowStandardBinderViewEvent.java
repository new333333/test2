...
/**
 * The ShowStandardBinderViewEvent is used to display a blog folder
 * 
 * @author david
 */
public class ShowStandardBinderViewEvent extends ShowBinderEvent<ShowStandardBinderViewEvent.Handler>
{
	...
	{
		void onShowStandardBinderView(ShowStandardBinderViewEvent event);
	}
	...
	{
		handler.onShowStandardBinderView(this );
	}
	...
	{
		return TeamingEvents.SHOW_STANDARD_BINDER_VIEW;
	}
